...
class Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $this->_ci->load->model('publicmodel');
        ...
        $this->_siteKey = $this->_ci->publicmodel->getSetting("api_key_recaptcha");
        $this->_secretKey = $this->_ci->publicmodel->getSetting("api_key_private");
        $this->_language = "ID";
