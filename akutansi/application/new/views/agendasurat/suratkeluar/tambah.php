                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Cari Officer" class="form-control" rel="tooltip" name="nofficer" id="nofficer" rel="tooltip" title="* Wajib diisi. <br>Pilih nama officer yang menerima berkas." disabled> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="nosurat" id="nosurat" rel="tooltip" title="* Wajib diisi. <br>Nomor suratnya secara lengkap."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="text" id="date" name="date" rel="tooltip" title="* Masukkan tanggal surat" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="perihal" id="perihal" rel="tooltip" title="* Wajib diisi. <br>Perihal mengenai surat yang dituliskan." rows="2"></textarea></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-2 control-label">Tujuan Surat <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="tujuan" id="tujuan" rel="tooltip" title="* Wajib diisi. <br>Dari siapa surat tersebut."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputemail" class="col-md-2 control-label">Catatan <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="catatan" id="catatan" rel="tooltip" title="* Wajib diisi. <br>Catatan atau keterangan mengenai surat." rows="2"></textarea></div>
                                        </div>
                                        <div class="row">
        ...
        <script>
            //Simpan Data
                ...
                function simpan()
                {
                    ...
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>suratkeluar/simpan",
                        data : {param : param},
                        dataType: 'json',
                        success : function (result){
                            console.log(result);
