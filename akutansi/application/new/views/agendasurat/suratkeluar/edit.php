    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Cari Officer" class="form-control" rel="tooltip" name="nofficer" id="nofficer"  value="<?php echo $suratkeluar->Data[0]->nama_officer; ?>" rel="tooltip" title="* Wajib diisi. <br>Pilih nama officer yang menerima berkas." disabled> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control"  value="<?php echo $suratkeluar->Data[0]->no_surat; ?>" rel="tooltip" name="nosurat" id="nosurat" rel="tooltip" title="* Wajib diisi. <br>Nomor suratnya secara lengkap."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="text"  value="<?php echo $suratkeluar->Data[0]->tgl_surat; ?>" id="date" name="date" rel="tooltip" title="* Masukkan tanggal surat" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="perihal" id="perihal" rel="tooltip" title="* Wajib diisi. <br>Perihal mengenai surat yang dituliskan." rows="2"><?php echo $suratkeluar->Data[0]->perihal; ?></textarea></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-2 control-label">Tujuan Surat <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <input type="text"  value="<?php echo $suratkeluar->Data[0]->tujuan_surat; ?>" class="form-control" rel="tooltip" name="tujuan" id="tujuan" rel="tooltip" title="* Wajib diisi. <br>Dari siapa surat tersebut."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputemail" class="col-md-2 control-label">Catatan <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="catatan" id="catatan" rel="tooltip" title="* Wajib diisi. <br>Catatan atau keterangan mengenai surat." rows="2"><?php echo $suratkeluar->Data[0]->catatan; ?></textarea></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-1" style="padding-left: 25px;">
                                                <a class="btn default" href="<?php echo base_url(); ?>suratkeluar">Batal</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
            ...
            //Simpan Data
                //Jenis simpan
                    $("#save_data").submit(function(){
                        ...
                        if(kondisi == "sukses"){
                            simpan();
                            window.location.href = "<?php echo base_url(); ?>suratkeluar";
                        }
                        return false;
                    })
                ...
                function simpan()
                {
                    var param = {
                             ...
                             "tujuan_surat" : $("#tujuan").val(),
                             "jenis_agenda" : "2",
                             "catatan" : $("#catatan").val()
                            }     
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>suratkeluar/edit",
                        data : {param : param , id : "<?php echo $suratkeluar->Data[0]->_id;  ?>"},
                        dataType: 'json',
                        success : function (result){
                            console.log(result);
                        }
                ...
                function before_simpan()
                {
                    ...
                    if((officer != "") && (nosurat != "") && (date != "") && (perihal != "") && (tujuan != "") && (catatan != ""))
                    {
                        kondisi = "sukses";
                    }else
                    {
        ...
        var m_kywd="" , m_utama ="", m_table="";
             ...
             $("#frmofficer").submit(function() {
                ...
                get_modal_data(search_data, "" , "suratkeluar/dataofficer", "#list-officer");   
                return false;
            ...
            function get_officer(kywd, hal )
            {
                ...
                console.log("hal: "+hal+" kywd: "+kywd);
                   $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>suratkeluar/dataofficer",
