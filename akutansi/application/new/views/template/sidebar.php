	...
	$isadmin = $loadakses->is_admin;
	$akses = str_split($loadakses->akses, 1);
	?>
	<!-- BEGIN SIDEBAR -->
	    ...
	    <div class="page-sidebar navbar-collapse collapse">
	        <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item <?php echo ($active == "laporan") ? 'active' : ''; ?>">
	                ...
	                <ul class="sub-menu">
	                    <li class="nav-item <?php echo ($active == "laporan" and $sub == "laporanumum") ? 'active' : ''; ?>">
	                        <a href="<?php echo base_url("laporan"); ?>" class="nav-link">
	                            <span class="title">Laporan Umum</span>
	                        </a>
	                    </li>
	                    <li class="nav-item <?php echo ($active == "laporan" and $sub == "laporanfidusia") ? 'active' : ''; ?>">
	                        <a href="<?php echo base_url("laporanfidusia"); ?>" class="nav-link">
	                            <span class="title">Laporan Fidusia</span>
	                        </a>
	                    </li>
	                </ul>
                </li>
	            ...
	            <li class="nav-item <?php echo ($active == "keuangan") ? 'active' : ''; ?>">
	                ...
	                <ul class="sub-menu">
	                    ...
	                    <li class="nav-item <?php echo ($active == "keuangan" and $sub == "laporan") ? 'active' : ''; ?>">
	                        <a href="<?php echo base_url("laporankeuangan"); ?>" class="nav-link">
	                            <span class="title">Laporan</span>
	                        </a>
	                    </li>
	                </ul>
