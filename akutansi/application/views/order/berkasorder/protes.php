...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Protes | eNotaris.com</title>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Tgl Akta </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_akta" class="form-control myDate" rel="tooltip" title="* Wajib diisi<br/> Tanggal Akta. <br />Format dd-mm-yyyy<br/> Contoh : 12-02-2014">
                                                    ...
                                                    <div class="form-group">
                                                        <label>No Akta </label><font color="red">*</font>
                                                        <input type="text" id="DU-no_akta" class="form-control" value="<?php echo $no_akta ?>" rel="tooltip" title="* Wajib diisi.<br/>Nomor Akta." required disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Sifat Akta </label><font color="red">*</font>
                                                        <input type="text" id="DU-sifat_akta" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Sifat Akta.">
                                                    </div>
                                                    <div class="row">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <label>Identitas </label><font color="red">*</font>
        ...
        <script>
            ...
            //getData
                ...
                function getDU()
                {
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            resp = resp['Data'][0];
                            if (resp != null){
                                $("#DU-no_akta").val(resp['no_akta'])
                                $("#DU-tgl_akta").val(tglIndo(resp['tgl_akta']))
                                $("#DU-sifat_akta").val(resp['sifat_akta'])
                            }
                        }
                    })
                    return false;   
                ...
                function getTP()
                {
                    ...
                    $.ajax({
                        type:'post',
                        url:"<?php echo base_url('berkasorder/protes/doSome') ?>",
            ...
            //insert
                ...
                $("#DU").submit(function(){
                    ...
                    if (cek == "sukses"){
                        param = {'id_order'         : "<?php echo $id_order ?>",
                                   'no_akta'         : $("#DU-no_akta").val(),
                                   'tgl_akta'        : formatDate($("#DU-tgl_akta").val()),
                                   'sifat_akta'      : $("#DU-sifat_akta").val(),
                ...
                {
                        tglakta = $("#DU-tgl_akta").val();
                        noakta = $("#DU-no_akta").val();
                        sifat = $("#DU-sifat_akta").val();

                        kondisi = "";
                        if((tglakta != "") && (noakta != "") && (sifat != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function cekfocus_du()
                {
                    if ($("#DU-tgl_akta").val() == ""){
                        $("#DU-tgl_akta").focus();
                    }else if ($("#DU-no_akta").val() == ""){
                        $("#DU-no_akta").focus();
                    }else if($("#DU-sifat_akta").val() == ""){
                        $("#DU-sifat_akta").focus();
                    }
