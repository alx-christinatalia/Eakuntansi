...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Penutupan PT | eNotaris.com</title>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  id="DU-alamat" rel="tooltip"  class="form-control" title="* Wajib diisi. Boleh diisi alamat Badan Usaha.">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="DU-kabkota_nama">
                                                    </div>
                                                    <div class="form-group">
                                                        <label >Tanggal Berdiri<font color="red"> *</font></label>
                                                        <div class="input-group input-medium date date-picker" >
                                                            <input type="text" class="form-control" id="DU-tgl_berdiri" onblur="FormatDateField(this)" onfocus="this.select()" rel="tooltip" title="* Wajib diisi.<br />Tanggal berdiri. Format yyyy-mm-dd<br/> Contoh : 2014-02-15">
                                                    ...
                                                    <div class="form-group">
                                                        <label>No Akta Berdiri </label><font color="red">*</font>
                                                        <input type="text"  id="DU-noakta_berdiri" rel="tooltip"  class="form-control" title="* Wajib diisi. No akta saat pendirian (untuk pembubaran)">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nama Pejabat Notaris </label><font color="red">*</font>
                                                        <input type="text"  id="DU-notaris_lama" rel="tooltip"  class="form-control" title="* Wajib diisi. Nama notaris yang membuat akta pendirian (untuk keperluan pembubaran)." >
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-2">
                                                            <input type="submit" class="btn btn-primary" value="Simpan"> 
        ...
        <script>
            ...
            //getData
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            ...
                            if(resp != null){
                                ...
                                $("#DU-tgl_berdiri").val(tglIndo(resp['tgl_berdiri']))
                ...
                function getNBU()
                {
                    ...
                    $.ajax({
                        type:'post',
                        url:"<?php echo base_url('berkasorder/penutupan_PT/NBUtable') ?>",
                        data:{param:param, tbl:tbl , method:method , sort:sort, limit:limit, filter:filter},
                        dataType:'json',
                        success: function (resp)
                        {
            ...
            //insert
                ...
                $("#DU").submit(function(){
                        ...
                        if (cek == "sukses"){
                            ...
                            $.ajax({
                                type:'post',
                                url:"<?php echo base_url('berkasorder/penutupan_PT/doSome') ?>",
                                data:{param:param, tbl:tbl , method:method , sort:sort, limit:limit, filter:filter , where : where},
                                dataType:'json',
                                success: function(resp)
                                {
                ...
                function before_simpan_du()
                {
                        ...
                        tglberdiri = $("#DU-tgl_berdiri").val();
                        noakta = $("#DU-noakta_berdiri").val();
                        nama = $("#DU-notaris_lama").val();

                        kondisi = "";
                        if((alamat != "") && (kedudukanperseroan != "") && (kedudukankabkota != "") && (tglberdiri != "") && (noakta != "") && (nama != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function cekfocus_du()
                {
                    if($("#DU-alamat").val() == ""){
                        ...
                        $("#DU-kabkota_id").focus();
                    }else if ($("#DU-tgl_berdiri").val() == ""){
                        $("#DU-tgl_berdiri").focus();
                    }else if($("#DU-noakta_berdiri").val() == ""){
                        $("#DU-noakta_berdiri").focus();
                    }else if ($("#DU-notaris_lama").val() == ""){
                        $( "#DU-notaris_lama" ).focus();
                    }
                }
            ...
            //Edit
                ...
                function pilih(selector)
                {
                    ...
                    $.ajax({
                        type:'post',
                        url:"<?php echo base_url('berkasorder/penutupan_PT/doSome') ?>/"+id,
                        data:{param:param, tbl:tbl , method:method , sort:sort, limit:limit, filter:filter, where:where},
                        dataType:'json',
                        success: function (resp)
                        {
