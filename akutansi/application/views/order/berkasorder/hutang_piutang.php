...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Hutang Piutang | eNotaris.com</title>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-obyek" class="form-control" rel="tooltip" title="* Wajib diisi. <br /> Obyek Hutang Piutang">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Ket Obyek</label><font color="red"> *</font>
                                                        <textarea  id="DU-ket" class="form-control area" rel="tooltip" title="* Wajib diisi.<br/>Deskripsi obyek Hutang Piutang"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nominal Hutang </label><font color="red">*</font>
                                                        <input type="text" id="DU-harga" class="form-control myMoney" rel="tooltip" title="* Wajib diisi. <br/>Nilai Hutang <br/>Format penulisan tanpa titik(.)<br/> Contoh : 100000000, akan terformat 100.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Angsuran </label>
                                                        <input type="text" id="DU-angsuran" class="form-control myMoney" rel="tooltip" title="Nominal angsuran, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000<small>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nominal Denda </label>
                                                        <input type="text" id="DU-denda_nominal" class="form-control myMoney" rel="tooltip" title="Nominal denda, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_angsuran" class="form-control myDate" rel="tooltip" title="Tanggal Angsuran. Format dd-mm-yyyy<br/> Contoh : 12-02-2014">
                                                            <span class="input-group-addon ">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="TP-pihak_alias" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pihak alias">
                                                            <option value="Pihak Pertama">Pihak Pertama (Kreditur)</option>
                                                            <option value="Pihak Kedua">Pihak Kedua (Debitur)</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
        ...
        <script>
                ...
                function getDU()
                {
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            resp = resp['Data'][0];
                            if(resp != null){
                                $("#DU-angsuran").val(returntoM(resp['angsuran']))
                                $("#DU-denda_nominal").val(returntoM(resp['denda_nominal']))
                                $("#DU-domisili").val(resp['domisili'])
                                $("#DU-harga").val(returntoM(resp['harga']))
                                $("#DU-ket").val(resp['ket'])
                                $("#DU-obyek").val(resp['obyek'])
                                $("#DU-pembayar").val(resp['pembayar'])
                                $("#DU-tgl_angsuran").val(tglIndo(resp['tgl_angsuran']))
            ...
            //insert
                ...
                $("#DU").submit(function(){
                    ...
                    if (cek == "sukses"){
                        param = {'id_order'         : "<?php echo $id_order ?>",
                                ...
                                'angsuran'          : returntoN($("#DU-angsuran").val()),
                                'denda_nominal'     : returntoN($("#DU-denda_nominal").val()),
                                'domisili'          : $("#DU-domisili").val(),
                                'harga'             : returntoN($("#DU-harga").val()),
                                'ket'               : $("#DU-ket").val(),
                                'obyek'             : $("#DU-obyek").val(),
                                'pembayar'          : $("#DU-pembayar").val(),
                                'tgl_angsuran'      :  formatDate($("#DU-tgl_angsuran").val()),
                ...
                function before_simpan_du()
                {
                        ...
                        kondisi = "";
                        if((obyek != "") && (ket != "") && (harga != "") && (waktu != "") && (mulai != "") && (batas != "") && (domisili != "") && (pembayar != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
