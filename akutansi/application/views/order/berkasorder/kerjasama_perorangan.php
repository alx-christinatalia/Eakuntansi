...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Kerjasama Perorangan | eNotaris.com</title>
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                <div class="page-title">
                                    <h1>Berkas Kerjasama Perorangan</h1>
                                </div>
                            </div>  
                        </div>
                        <!-- END PAGE TITLE -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Bidang Kerjasama </label><font color="red">*</font>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Perihal Kerjasama</label><font color="red"> *</font>
                                                        <textarea  id="DU-perihal" class="form-control area" rel="tooltip" title="* Wajib diisi.<br/>Perihal tentang kerjasama.<br/>Di jelaskan secara rinci perihal bentuk kerjasama."></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Modal Awal </label><font color="red">*</font>
                                                        <input type="text" id="DU-modal" class="form-control myMoney" rel="tooltip" title="* Wajib diisi.<br/>Modal dalam kerjasama.<br/> Contoh : 100000000 akan terformat 100.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Uraian Keuntungan</label><font color="red"> *</font>
                                                        <textarea  id="DU-uraian" class="form-control area" rel="tooltip" title="* Wajib diisi.<br/>Uraian lengkap tentang bentuk kerjasama"></textarea>
                                                    </div>
                                                    <div class="row">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Kewajiban </label><font color="red">*</font>
                                                        <textarea id="TP-kewajiban" class="form-control area" rel="tooltip" title="* Wajib diisi.<br/>Jelaskan kewajiban - kewajiban di dalam kerjasama ini<br/> Contoh : Menanggung biaya operasional dst."></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-2">
                                                            <input type="submit" class="btn btn-primary" value="Simpan"> 
        ...
        <script>
            ...
            //insert
                ...
                function before_simpan_du()
                {
                        ...
                        kondisi = "";
                        if((bidang != "") && (perihal != "") && (modal != "") && (waktu != "") && (batas != "") && (uraian != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function before_simpan_tp(){
                    ...
                    if ((nama != "") && (ket != "") && (pihak != "") && (alias != "") && (kewajiban != "")){
                        kondisi = "sukses";
                    }else{
                        notifShow("error", "Masukkan data formulir dengan benar");
                        kondisi = "gagal";
