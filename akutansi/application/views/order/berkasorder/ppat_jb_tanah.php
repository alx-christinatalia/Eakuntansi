...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas PPAT JB Tanah | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="DU-hak_milik" class="form-control" title="* Wajib diisi.<br/>Bukti kepemilikan tanah." rel="tooltip">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-status_tanah" class="form-control" title="* Wajib Diisi <br/> Jenis dan nomor hak. <br/> Contoh: Hak Milik No:528." rel="tooltip">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Bentuk Obyek </label><font color="red">*</font>
                                                        <input type="text" id="DU-obyek" class="form-control" title="* Wajib Diisi <br/> Bentuk obyek <br/> Contoh : Sebidang Tanah." rel="tooltip">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>No Surat Ukur </label><font color="red">*</font>
                                                        <input type="text" id="DU-no_surat" class="form-control" title="* Wajib Diisi <br/> Nomor surat ukur. <br/> Contoh : 35x / Lowokwaru /2002" rel="tooltip">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl Surat Ukur </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_srt_ukur" class="form-control myDate" title="* Wajib diisi<br/> Tanggal surat ukur. <br />Format dd-mm-yyyy<br/> Contoh : 12-02-2014" rel="tooltip">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-nib" class="form-control" title="* Wajib Diisi. <br/> No NOB. <br/> Contoh : 11.19.08.03.00xxx" rel="tooltip">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>No. NOP</label>
                                                        <input type="text" id="DU-no_nop" class="form-control" title="No. NOP. <br/> Contoh : 33.10.710.003.001-0xxx.0" rel="tooltip">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tahun NOP</label>
                                                        <input type="text" id="DU-thn_nop" class="form-control" title="Tahun NOP. <br/> Contoh : 2011" rel="tooltip">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-5"> 
                                                                    <label>Nominal NJOP </label>
                                                                <input type="text" id="DU-njop" class="form-control myMoney" rel="tooltip" title="Nominal NJOP. <br/> Contoh : 35.000.000">
                                                            </div>
                                                            <div class="col-md-1" style="padding-top:30px">
                                                                <span>/</span>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" id="DU-njop2"  class="form-control myMoney" style="margin-top: 25px;" rel="tooltip" title="Luas Bidang Tanah yang di NJOP.">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl SSP </label>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-ssp_tgl" class="form-control myDate" rel="tooltip" title="Tanggal pembayaran SSP.">
                                                            <span class="input-group-addon ">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-ssp_rp" class="form-control myMoney" rel="tooltip" title="Nominal pembayaran SSP.<br/>Format penulisan tanpa titik(.)<br/> Contoh : 100000000, akan terformat 100.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl SSPD BPHTB </label>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-sspd_tgl" class="form-control myDate" rel="tooltip" title="Tanggal pembayaran SSPD BPHTB.">
                                                            <span class="input-group-addon ">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-sspd_rp" class="form-control myMoney" rel="tooltip" title="Nominal SSPD BPHTB <br/>Format penulisan tanpa titik(.)<br/> Contoh : 100000000, akan terformat 100.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-11">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" id="DU-alamat" class="form-control area" rel="tooltip" title="*Wajib Diisi <br/> Alamat kedudukan obyek tanah. "></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Desa/Kelurahan</label><font color="red"> *</font>
                                                        <input type="text" id="DU-desa" class="form-control" rel="tooltip" title="*Wajib Diisi <br/> Letak desa atau kelurahan tempat kedudukan obyek. <br/> Contoh : Lowokwaru. ">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kecamatan</label><font color="red"> *</font>
                                                        <input type="text" id="DU-kec" class="form-control" rel="tooltip" title="*Wajib Diisi <br/> Letak kecamatan tempat kedudukan obyek. <br/> Contoh : Lowokwaru.">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Provinsi</label><font color="red"> *</font>
                                                        <select type="text" id="DU-provinsi" class="form-control mySelect2 prov" rel="tooltip" title="* Wajib diisi.<br/> Pilih Provinsi yang tersedia berdasarkan Area Kerja Notaris/PPAT.">
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kab / Kota</label><font color="red"> *</font>
                                                        <select type="text" id="DU-Kota" class="form-control mySelect2 kota" rel="tooltip" title="* Wajib diisi.<br/> Pilih Kabupaten atau Kota yang tersedia berdasarkan Area Kerja Notaris/PPAT.">
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Harga Transaksi</label>
                                                        <input type="text" id="DU-harga" class="form-control myMoney" rel="tooltip" title="Harga Transaksi.<br/>Format penulisan tanpa titik(.)<br/> Contoh : 100000000, akan terformat 100.000.000 ">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Obyek Meliputi</label>
                                                        <textarea type="text" id="DU-meliputi" class="form-control area" rel="tooltip" title="Obyek yang juga ikut dalam perjanjian. <br/>Contoh : Sebidang tanah pekarangan."></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Domisili Pengadilan</label><font color="red"> *</font>
                                                        <input type="text" id="DU-tmpt_domisili" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Domisili Kantor  Panitera Pengadilan Negeri. Contoh : Kabupaten Malang">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pihak Pembayar</label>
                                                        <input type="text" id="DU-pihak_bayar" class="form-control" rel="tooltip" title="Jika terdapat nama yang membayar akta perjanjian.">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Keterangan</label>
                                                        <textarea type="text" id="DU-keterangan" class="form-control area" rel="tooltip" title="Keterangan tambahan jika diperlukan. <br/> (Akan muncul dalam kolom keterangan laporan PPAT)"></textarea>
                                                    </div>
                                                    <div class="row">
                                ...
                                <div class="portlet light bordered">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="TP-nama_menguasakan" class="form-control" rel="tooltip" title="Nama pihak yang menguasakan.<br/>Contoh : Bagus Abdurrahman, ST">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                        ...
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <span class="caption-subject font-dark bold uppercase">Pihak Yang Menyetujui</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="TP-nama_menyetujui" class="form-control" rel="tooltip" title="Nama pihak yang menyetujui.<br/>Contoh : Bagus Abdurrahman, ST">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <label>Identitas Menyetujui </label>
                                                            <textarea type="text"  rel="tooltip"  class="form-control" id="TP-identitas_menyetujui" title="Diisi dengan keterangan pihak yang menyetujui. Contoh : Lahir di Malang, pada tanggal 28(dua puluh delapan) SEPTEMBER 1988 (seribu sembilan ratus delapan puluh delapan), Warga Negara Indonesia, Karyawan Swasta, bertempat tinggal di Malang, Jalan Pasir Luhur 28, Rukun Tetangga 007, Rukun Warga 002, Desa Jenggolo, Kecamatan Kepanjen, Pemegang Kartu Tanda Penduduk dengan Nomor Induk Kependudukan 3507132809880001;"></textarea>
                                                                <span class="input-group-btn" style="padding-top: 7px;">
                                                                    <a data-toggle="modal" href="#template" onclick="ambiltem(this);" class="btn green-turquoise" title="Pilih Template" id="isetuju">
                                                                      <i class="fa fa-search"></i>
                                                                    </a>
                                                                </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="TP-stt_pihak_menyetujui" class="form-control" rel="tooltip" title="Hubungan dengan pihak pemberi fidusia <br/> Contoh: Istri, Suami, Ayah dll.">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-2">
                                                            <input type="submit" class="btn btn-primary" value="Simpan"> 
        ...
        <script>
            ...
            //insert
                ...
                {
                        bukti = $("#DU-hak_milik option:selected").val();
                        jenisnohak = $("#DU-status_tanah").val();
                        bentuk = $("#DU-obyek").val();
                        nosuratukur = $("#DU-no_surat").val();
                        tglsuratukur = $("#DU-tgl_srt_ukur").val();
                        nib = $("#DU-nib").val();
                        luastanah = $("#DU-luas_tanah").val();
                        alamat = $("#DU-alamat").val();
                        desa = $("#DU-desa").val();
                        kecamatan = $("#DU-kec").val();
                        provinsi = $("#DU-provinsi option:selected").val();
                        kabkota = $("#DU-Kota option:selected").val();
                        dom = $("#DU-tmpt_domisili").val();

                        kondisi = "";
                        if((bukti != "") && (jenisnohak != "") && (bentuk != "") && (nosuratukur != "") && (tglsuratukur != "") && (nib != "") && (luastanah != "") && (alamat != "") && (desa != "") && (kecamatan != "") && (provinsi != "") && (kabkota != "") && (dom != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                {
                    if($("#DU-hak_milik option:selected").val() == ""){
                        $("#DU-hak_milik").focus();
                    }else if($("#DU-status_tanah").val() == ""){
                        $("#DU-status_tanah").focus();
                    }else if ($("#DU-obyek").val() == ""){
                        $("#DU-obyek").focus();
                    }else if($("#DU-no_surat").val() == ""){
                        $("#DU-no_surat").focus();
                    }else if($("#DU-tgl_srt_ukur").val() == ""){
                        $("#DU-tgl_srt_ukur").focus();
                    }else if ($("#DU-nib").val() == ""){
                        $("#DU-nib").focus();
                    }else if($("#DU-luas_tanah").val() == ""){
                        $("#DU-luas_tanah").focus();
                    }else if($("#DU-alamat").val() == ""){
                        $("#DU-alamat").focus();
                    }else if ($("#DU-desa").val() == ""){
                        $("#DU-desa").focus();
                    }else if($("#DU-kec").val() == ""){
                        ...
                        $("#DU-Kota").focus();
                    }else if($("#DU-tmpt_domisili").val() == ""){
                        $("#DU-tmpt_domisili").focus();
                    }
                ...
                function before_simpan_tp(){
                    ...
                    pihakke = $("#TP-pihak_ke option:selected").val()
                    pihakalias = $("#TP-pihak_alias option:selected").val()
                    nama = $("#TP-nama").val() 
                    ket = $("#TP-ket").val()

                    if ((nama != "") && (ket != "") && (pihakke != "") && (pihakalias != "")){
                        kondisi = "sukses";
                    }else{
                        notifShow("error", "Masukkan data formulir dengan benar");
                        kondisi = "gagal";
