...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Perubahan Yayasan | eNotaris.com</title>
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                <div class="page-title">
                                    <h1>Berkas Perubahan Yayasan</h1>
                                </div>
                            </div>  
                        </div>
                        <!-- END PAGE TITLE -->
        ...
        var p_nama_layanan = "" , p_id_layanan = "";
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            ...
                            if (resp != null){
                                ...
                                $("#DU-cara_peroleh").val(resp['cara_peroleh'])
                                $("#DU-alamat").val(resp['alamat'])
                                $("#DU-kabkota").val(resp['kabkota'])
                                
                                $.when(getKota()).done(function(){
            ...
            //insert
                ...
                $("#DU").submit(function(){
                        ...
                        if (cek == "sukses"){
                            param = {'id_order'         : "<?php echo $id_order ?>",
                                     ...
                                     'cara_peroleh'     : $("#DU-cara_peroleh").val(),
                ...
                function before_simpan_du()
                {
                        ...
                        kondisi = "";
                        if((tujuan != "") && (asalkekayaan != "") && (cara != "") && (kedudukan != "") && (kedudukank != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
