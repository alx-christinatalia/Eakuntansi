...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Pinjam Pakai | eNotaris.com</title>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-obyek" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Penyebutan obyek yang dijual atau hibahkan.<br/>Contoh : Sebidang Tanah, Tanah atau Bangunan">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-ganti_rugi" class="form-control myMoney" rel="tooltip" title="* Tidak Wajib diisi.<br/>Nominal ganti rugi, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="TP-pihak_alias" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pihak alias.">
                                                            <option value="Pihak Pertama">Pihak Pertama (Pemilik) </option>
                                                            <option value="Pihak Kedua">Pihak Kedua (Peminjam) </option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
