...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Pendirian Yayasan | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                <div class="page-title">
                                    <h1>Berkas Pendirian Yayasan</h1>
                                </div>
                            </div>  
                        </div>
                        <!-- END PAGE TITLE -->
                                    ...
                                    <div class="portlet-body">
                                        <form id="DU" onsubmit="return false">
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Tujuan / Kegiatan </label><font color="red">*</font>
                                                        <textarea type="text" id="DU-tujuan" rel="tooltip"  class="form-control area" title="* Wajib diisi<br/> Tujuan didirikannya Yayasan.<br/>Contoh : Yayasan untuk Panti Asuhan"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kekayaan Awal </label><font color="red">*</font>
                                                        <input type="text" id="DU-modaldasar" rel="tooltip"  onfocus='toN(this);' onblur='toM(this);' class="form-control" title="* Wajib diisi.<br/>Jumlah nominal saham yang disetor oleh pengurus<br/>format pengisian tanpa titik(.) Contoh : 20000000, secara otomatis menjadi 20.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Asal Kekayaaan </label><font color="red">*</font>
                                                        <textarea type="text"  id="DU-asal_kekayaan" rel="tooltip"  class="form-control area" title="* Wajib diisi<br/>Menyebutkan Asal kekayaan.<br/>Contoh : Dari donatur atau organisasi"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Cara Memperoleh </label><font color="red">*</font>
                                                        <textarea type="text"  id="DU-cara_memperoleh" rel="tooltip"  class="form-control area" title="* Wajib diisi<br/>Menyebutkan cara memperoleh dana/kekayaan."></textarea>
                                                    </div>
                                                    <div class="form-group">
        ...
        var p_nama_layanan = "" , p_id_layanan = "";
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            ...
                            if (resp != null){
                                ...
                                $("#DU-asal_kekayaan").val(resp['asal_kekayaan'])
                                $("#DU-cara_memperoleh").val(resp['cara_peroleh'])
                            }
                        }
                    })
                    return false;   
            ...
            //insert
                ...
                $("#DU").submit(function(){
                        ...
                        if (cek == "sukses"){
                            param = {'id_order'         : "<?php echo $id_order ?>",
                                     ...
                                     'asal_kekayaan'    : $("#DU-asal_kekayaan").val(),
                                     'cara_peroleh'     : $("#DU-cara_memperoleh").val(),
                ...
                {
                        tujuan = $("#DU-tujuan").val();
                        kekayaan = $("#DU-modaldasar").val();
                        asalkekayaan = $("#DU-asal_kekayaan").val();
                        cara = $("#DU-cara_memperoleh").val();
                        alamat = $("#DU-alamat").val();
                        ...
                        kondisi = "";
                        if((tujuan != "") && (kekayaan != "") && (asalkekayaan != "") && (cara != "") && (alamat != "") && (kedudukan != "") && (kedudukank != "") && (jangkawaktu != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function cekfocus_du()
                {
                    if($("#DU-tujuan").val() == ""){
                        $("#DU-tujuan").focus();
                    }else if ($("#DU-modaldasar").val() == ""){
                        $("#DU-modaldasar").focus();
                    }else if($("#DU-asal_kekayaan").val() == ""){
                        $("#DU-asal_kekayaan").focus();
                    }else if ($("#DU-cara_memperoleh").val() == ""){
                        $("#DU-cara_memperoleh").focus();
