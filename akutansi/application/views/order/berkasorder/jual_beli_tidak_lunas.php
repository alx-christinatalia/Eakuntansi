...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Jual Beli Tidak Lunas | eNotaris.com</title>
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                <div class="page-title">
                                    <h1>Berkas Jual Beli Tidak Lunas</h1>
                                </div>
                            </div>  
                        </div>
                        <!-- END PAGE TITLE -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Obyek </label><font color="red">*</font>
                                                        <input type="text" id="DU-obyek" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Penyebutan obyek yang dijual.<br/>Contoh : Mobil, sepeda motor dll">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Ket Obyek</label><font color="red"> *</font>
                                                        <textarea  id="DU-ket" class="form-control area" rel="tooltip" title="* Wajib diisi.<br/>Deskripsi obyek (luas, tipe dan merek)"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Harga </label><font color="red">*</font>
                                                        <input type="text" id="DU-harga" class="form-control myMoney" rel="tooltip" title="* Wajib diisi.<br/>harga yang disepakati, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nominal Yang Dibayar </label>
                                                        <input type="text" id="DU-bayar" class="form-control myMoney" rel="tooltip" title="Nominal yang sudah dibayar<br/> format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Sisa Bayar </label>
                                                        <input type="text" id="DU-sisa" class="form-control myMoney" rel="tooltip" title="Sisa yang belum dibayar, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Persen Denda </label>
                                                        <input type="text" id="DU-denda" class="form-control" rel="tooltip" title="Persentase denda ganti rugi .<br/>Contoh : 2,5 %">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Jangka Waktu </label>
                                                        <input type="text" id="DU-waktu" class="form-control" rel="tooltip" title="Jangka waktu pelunasan.<br/>Contoh : 36 Bulan">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Ganti Rugi </label>
                                                        <input type="text" id="DU-ganti_rugi" class="form-control myMoney" rel="tooltip" title="Nominal ganti rugi.<br/>Contoh : 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Domisil Pengadilan </label><font color="red">*</font>
                                                        <input type="text" id="DU-domisili" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Kantor Kepaniteraan  Pengadilan Negeri.<br/>Contoh : Kabupaten Malang">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pihak Pembayar  </label><font color="red">*</font>
                                                        <input type="text" id="DU-pembayar" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pihak yang membayar dalam pengurusan akta ini.<br/>Contoh : Tuan Sudirman">
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="TP-nama" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Nama Pihak Terkait.<br/>Contoh : Bagus Abdurrahman, ST">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <select id="TP-pihak_ke" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pihak ke">
                                                            <option value="1">Pihak Ke 1</option>
                                                            <option value="2">Pihak Ke 2</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <select id="TP-pihak_alias" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pihak alias.">
                                                            <option value="1">Pihak Pertama (Penjual)</option>
                                                            <option value="2">Pihak Kedua (Pembeli)</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="TP-suratnikah" class="form-control" rel="tooltip" title="Nomor Surat nikah/ Cerai.<br/>Contoh : 7832">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-2">
                                                            <input type="submit" class="btn btn-primary" value="Simpan"> 
        ...
        <script>
            ...
            //getData
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            ...
                            if (resp != null){
                                 ...
                                 $("#DU-ket").val(resp['ket'])
                                 $("#DU-harga").val(returntoM(resp['harga']))
                                 $("#DU-bayar").val(returntoM(resp['bayar']))
                                 $("#DU-sisa").val(returntoM(resp['sisa']))
                                 $("#DU-tgl_batas").val(tglIndo(resp['tgl_batas']))
                                 $("#DU-denda").val(resp['denda'])
                                 $("#DU-domisili").val(resp['domisili'])
                                 $("#DU-pembayar").val(resp['pembayar'])
                                 $("#DU-waktu").val(resp['waktu'])
                                 $("#DU-ganti_rugi").val(returntoM(resp['ganti_rugi']))    
                            }
                        }
                    })
                    return false;   
                ...
                function getTP()
                {
                    ...
                    $.ajax({
                        type:'post',
                        url:"<?php echo base_url('berkasorder/jual_beli_lunas/doSome') ?>",
            ...
            //insert
                ...
                $("#DU").submit(function(){
                    ...
                    if (cek == "sukses"){
                            param = {'id_order'         : "<?php echo $id_order ?>",
                                     ...
                                     'bayar'            : returntoN($("#DU-bayar").val()),
                                     'sisa'             : returntoN($("#DU-sisa").val()),
                                     'tgl_batas'        : formatDate($("#DU-tgl_batas").val()),
                                     'denda'            : $("#DU-denda").val(),
                                     'domisili'         : $("#DU-domisili").val(),
                                     'pembayar'         : $("#DU-pembayar").val(),
                                     'waktu'            : $("#DU-waktu").val(),
                                     'ganti_rugi'       : returntoN($("#DU-ganti_rugi").val()),
                ...
                function before_simpan_du()
                {
                        ...
                        kondisi = "";
                        if((obyek != "") && (ket != "") && (harga != "") && (batas != "") && (domisili != "") && (pembayar != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function cekfocus_du()
                {
                    if($("#DU-obyek").val() == ""){
                        ...
                        $("#DU-ket").focus();
                    }else if($("#DU-harga").val() == ""){
                        $("#DU-harga").focus();
                    }else if ($("#DU-tgl_batas").val() == ""){
                        $("#DU-tgl_batas").focus();
                    }else if ($("#DU-domisili").val() == ""){
                        $( "#DU-domisili" ).focus();
                ...
                $("#TP").submit(function(){
                    ...
                    if(cek == "sukses"){
                        param = {'id_order'         : "<?php echo $id_order ?>",
                                 'nama'             : $("#TP-nama").val(),
                                 'pihak_ke'         : $("#TP-pihak_ke").val(),
                                 'pihak_alias'      : $("#TP-pihak_alias").val(),
                                 'ket'              : $("#TP-ket").val(),
