...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Jual Beli Lunas | eNotaris.com</title>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-obyek" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Penyebutan obyek yang dijual.<br/>Contoh : Sebidang Tanah, Tanah atau Bangunan">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Nominal Yang Dibayar </label><font color="red">*</font>
                                                        <input type="text" id="DU-bayar" class="form-control myMoney" rel="tooltip" title="* Wajib diisi.<br/>Nominal uang yang sudah dibayar, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Prosentase Denda </label>
                                                        <input type="text" id="DU-denda" class="form-control" rel="tooltip" title="Prosentase denda yang dibebankan contoh : 4%">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Pihak Pembayar Akta </label><font color="red">*</font>
        ...
        <script>
            ...
            //insert
                ...
                function before_simpan_du()
                {
                        ...
                        kondisi = "";
                        if((obyek != "") && (ket != "") && (harga != "") && (bayar != "") && (denda != "") && (domisili != "") && (pembayar != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function cekfocus_du()
                {
                    if($("#DU-obyek").val() == ""){
                        ...
                        $("#DU-harga").focus();
                    }else if ($("#DU-bayar").val() == ""){
                        $("#DU-bayar").focus();
                    }else if($("#DU-denda").val() == ""){
                        $("#DU-denda").focus();
