...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Wasiat | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Isi Wasiat </label><font color="red">*</font>
                                                        <textarea  id="DU-isi_wasiat" class="form-control area" rel="tooltip" title="* Wajib diisi.<br/>Isi daripada akta wasiatnya."></textarea>
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-detail">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Nama</th>
                                                        <th>Sebagai</th>
                                                        <th>Identitas Pihak</th>
                                                        <th>Hubungan Pihak</th>
                                                        <th>Pekerjaan</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="tb-TP">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="TP-nama" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Nama.<br/>Contoh : Bagus Abdurrahman, ST">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nama Dahulu  </label><font color="red">*</font>
                                                        <input id="TP-nama_dahulu" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Nama dahulu.">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pihak Sebagai  </label><font color="red">*</font>
                                                        <select id="TP-pihak_sbg" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pihak sebagai.">
                                                            <option value="1">Penghadap</option>
                                                            <option value="2">Ahli Waris</option>
                                                            <option value="3">Pelaksana Wasiat</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tempat Lahir  </label><font color="red">*</font>
                                                        <input id="TP-tmp_lahir" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Tempat Lahir.<br/>Contoh : Malang">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl Lahir </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" id="TP-tgl_lahir" class="form-control myDate" rel="tooltip" title="* Wajib diisi<br/> Tanggal lahir. <br />Format dd-mm-yyyy<br/> Contoh : 12-02-2014">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Hubungan Pihak  </label><font color="red">*</font>
                                                        <input id="TP-hubungan_pihak" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Hubungan Pihak dengan Klien. <br/>Contoh: Saudara">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pekerjaan  </label><font color="red">*</font>
                                                        <input id="TP-pekerjaan" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pekerjaan pihak tsb.<br/>Contoh: Pekerja Swasta">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Alamat Terakhir </label><font color="red">*</font>
                                                        <textarea  id="TP-alamat_terahir" class="form-control area" rel="tooltip" title="* Wajib diisi.<br/>Alamat terakhir pihak menyetujui.<br/>Contoh: Jl. Soekarno-Hatta No. 15D Kota Malang"></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-2">
                                                            <input type="submit" class="btn btn-primary" value="Simpan"> 
        ...
        <script>
            //template
            function pakaitem(){
                $("#TP-identitas_pihak").val($("#teks").val());
            }
            function updatetem(){
                var _id =  $("#idt").val();
        ...
        <script>
            ...
            //getData
                ...
                function getDU()
                {
                    ...
                    $.ajax({
                        ...
                        {
                            resp = resp['Data'][0];
                            if (resp != null){$("#DU-isi_wasiat").val(resp['isi_wasiat'])}
                        }
                    })
                    return false;   
                }
                ...
                function getTP()
                {
                    ...
                    $.ajax({
                        type:'post',
                        url:"<?php echo base_url('berkasorder/wasiat/doSome') ?>",
            ...
            //insert
                ...
                $("#DU").submit(function(){
                    if ($("#DU-isi_wasiat").val() != null){
                        param = {'id_order'         : "<?php echo $id_order ?>",
                                'isi_wasiat'         : $("#DU-isi_wasiat").val(),
               ...
               $("#TP").submit(function(){
                    ...
                    if (cek == "sukses"){
                        param = {'id_order'         : "<?php echo $id_order ?>",
                                 'nama'             : $("#TP-nama").val(),
                                 'nama_dahulu'      : $("#TP-nama_dahulu").val(),
                                 'pihak_sbg'        : $("#TP-pihak_sbg").val(),
                                 'tmp_lahir'        : $("#TP-tmp_lahir").val(),
                                 'tgl_lahir'        : formatDate($("#TP-tgl_lahir").val()),
                                 'identitas_pihak'  : $("#TP-identitas_pihak").val(),
                                 'hubungan_pihak'         : $("#TP-hubungan_pihak").val(),
                                 'pekerjaan'        : $("#TP-pekerjaan").val(),
                                 'alamat_terahir'   : $("#TP-alamat_terahir").val(),
                                 'layanan'          : p_id_layanan,
                                 'tgl_input'          : hariini()
                             };
                ...
                function before_simpan_tp(){
                    var kondisi;
                    nama = $("#TP-nama").val()
                    dahulu = $("#TP-nama_dahulu").val()
                    sbg = $("#TP-pihak_sbg").val()
                    tmpt = $("#TP-tmp_lahir").val()
                    lahir = $("#TP-tgl_lahir").val()
                    identitas = $("#TP-identitas_pihak").val()
                    hubungan = $("#TP-hubungan_pihak").val()
                    pekerjaan = $("#TP-pekerjaan").val()
                    alamat = $("#TP-alamat_terahir").val()

                    if ((nama != "") && (dahulu != "") && (sbg != "") && (tmpt != "") && (lahir != "") && (identitas != "") && (hubungan != "") && (pekerjaan != "") && (alamat != "")){
                        kondisi = "sukses";
                    }else{
                        notifShow("error", "Masukkan data formulir dengan benar");
                        kondisi = "gagal";
                ...
                function cekfocus_tp(){
                    if ($("#TP-nama").val() == ""){
                        $("#TP-nama").focus()
                    }else if($("#TP-nama_dahulu").val() == ""){
                        $("#TP-nama_dahulu").focus()
                    }else if ($("#TP-pihak_sbg").val() == ""){
                        $("#TP-pihak_sbg").focus()
                    }else if($("#TP-tmp_lahir").val() == ""){
                        $("#TP-tmp_lahir").focus()
                    }else if ($("#TP-tgl_lahir").val() == ""){
                        $("#TP-tgl_lahir").focus()
                    }else if($("#TP-identitas_pihak").val() == ""){
                        $("#TP-identitas_pihak").focus()
                    }else if ($("#TP-hubungan_pihak").val() == ""){
                        $("#TP-hubungan_pihak").focus()
                    }else if($("#TP-pekerjaan").val() == ""){
                        $("#TP-pekerjaan").focus()
                    }else if($("#TP-alamat_terahir").val() == ""){
                        $("#TP-alamat_terahir").focus()
                    }
                }
                    ...
                    $.ajax({
                        ...
                        {   
                            ...
                            console.log(resp)
                                 ...
                                 $("#TP-nama_dahulu").val(resp['nama_dahulu'])
                                 $("#TP-pihak_sbg").val(resp['pihak_sbg'])
                                 $("#TP-tmp_lahir").val(resp['tmp_lahir'])
                                 $("#TP-tgl_lahir").val(tglIndo(resp['tgl_lahir']))
                                 $("#TP-identitas_pihak").val(resp['identitas_pihak'])
                                 $("#TP-hubungan_pihak").val(resp['hubungan_pihak'])
                                 $("#TP-pekerjaan").val(resp['pekerjaan'])
                                 $("#TP-alamat_terahir").val(resp['alamat_terahir'])
