...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas APHT | eNotaris.com</title>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" rel="tooltip" id="DU-jenis_perjanjian" class="form-control" title="*Wajib Diisi <br /> Diisi jenis perjanjian yang dilakukan sebelumnya. <br /> Contoh: Perjanjian Hutang atau Perjanjian Kredit " >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nomor Perjanjian </label><font color="red">*</font>
                                                        <input type="text" rel="tooltip" id="DU-nomor_perjanjian" class="form-control" title="*Wajib Diisi <br /> Diisi nomor surat perjanjian hutang atau perjanjian kredit. <br> Contoh : 30.13.xx.xx.000xx " >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl Perjanjian </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_perjanjian" rel="tooltip" class="form-control myDate" title="* Wajib diisi.<br/>*) Gunakan 2, 4, atau 6 digit angka.<br/> Contoh : <strong>10</strong> maka akan menjadi 10-{month}-{year}.<br/> <strong>1010</strong> maka akan menjadi 10-10-{year}. <br/><strong>101014</strong> maka akan menjadi 10-10-2014. " >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" rel="tooltip" id="DU-jenis_obyek" class="form-control" title="* Wajib Diisi <br/> Bentuk obyek dalam perjanjian. <br/> Contoh : 1 hak atas tanah" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Jenis & Nomor Hak </label><font color="red">*</font>
                                                        <input type="text" rel="tooltip" id="DU-jenis_no_hak" class="form-control" title="* Wajib Diisi <br/> Jenis dan nomor hak. <br/> Contoh: Hak Milik No:528." >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>No Surat Ukur </label><font color="red">*</font>
                                                        <input type="text" rel="tooltip" id="DU-no_surat" class="form-control" title="* Wajib Diisi <br/> Nomor surat ukur. <br/> Contoh : 35x / Lowokwaru /2002" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl Surat Ukur </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" rel="tooltip" id="DU-tgl_surat" class="form-control myDate" title="* Wajib diisi<br/> Tanggal surat ukur. <br />Format dd-mm-yyyy<br/> Contoh : 12-02-2014" >
                                                            <span class="input-group-addon ">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>NIB </label>
                                                        <input type="text" rel="tooltip" id="DU-nib" class="form-control" title="*Tidak Wajib Diisi. <br/> No NOB. <br/> Contoh : 11.19.08.03.00xxx " >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>No. NOP</label>
                                                        <input type="text" rel="tooltip" id="DU-no_nop" class="form-control" title="No. NOP. <br/> Contoh : 33.10.710.003.001-0xxx.0 " >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tahun NOP</label>
                                                        <input type="text" rel="tooltip" id="DU-thn_nop" class="form-control" title="Tahun NOP. <br/> Contoh : 2011 ">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-11">
                                                                <label>Luas Tanah</label><font color="red"> *</font>
                                                                <input type="text" rel="tooltip" title="*Wajib Diisi. <br/> Luas tanah. <br/> Contoh : 140" id="DU-luas_tanah" class="form-control" >
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-11">
                                                                ...
                                                                <input type="text" rel="tooltip" title="Luas bangunan. <br/> Contoh : 140" id="DU-luas_bangunan" class="form-control">
                                                            </div>
                                                            <div class="col-md-1" style="margin-top: 30px">
                                                                 m<sup>2</sup>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" rel="tooltip" title="* Wajib diisi. <br/>Nilai Hutang dalam perjanjian <br/>Format penulisan tanpa titik(.)<br/> Contoh : 100000000, akan terformat 100.000.000" id="DU-nominal_hutang" class="form-control myMoney" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nominal Tanggungan</label><font color="red"> *</font>
                                                        <input type="text" rel="tooltip" title="* Wajib diisi. <br/>Nilai Tanggungan dalam perjanjian <br/>Format penulisan tanpa titik(.)<br/> Contoh : 100000000, akan terformat 100.000.000" id="DU-nominal_tanggung" class="form-control myMoney" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Provinsi</label><font color="red"> *</font>
                                                        <select type="text" rel="tooltip" id="DU-provinsi" title="* Wajib Diisi <br/> Pilih Provinsi kedudukan obyek." class="form-control mySelect2 prov" >
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kab / Kota</label><font color="red"> *</font>
                                                        <select type="text" rel="tooltip" title="* Wajib Diisi <br/> Pilih Kabupaten / Kota kedudukan obyek." id="DU-Kota" class="form-control mySelect2 kota" >
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kecamatan</label><font color="red"> *</font>
                                                        <input type="text" rel="tooltip" id="DU-kec" title="* Wajib Diisi <br/> Pilih Kecamatan kedudukan obyek." class="form-control" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Desa/Kelurahan</label><font color="red"> *</font>
                                                        <input type="text" rel="tooltip" id="DU-desa_kel" title="* Wajib Diisi <br/> Pilih Desa / Kelurahan kedudukan obyek." class="form-control" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Obyek Meliputi</label>
                                                        <textarea type="text" rel="tooltip" title="Jika terdapat benda atau apapun yang ikut dalam obyek tersebut. <br> Contoh : Segala sesuatu yang berdiri dan/atau dikemudian hari akan didirikan atau yang lekat diatas tanah tersebut yang menurut sifat,guna dan peruntukannya berdasarkan Undang-undang dan peraturan-peraturan yang berlaku dapat dianggap sebagai barang tidak bergerak." id="DU-obyek_meliputi" class="form-control area" ></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Keterangan</label>
                                                        <textarea type="text" rel="tooltip" title="Diisi dengan keterangan yang dibutuhkan. <br/> (Akan tampil pada kolom keterangan di laporan PPAT)" id="DU-desk_obyek" class="form-control area" ></textarea>
                                                    </div>
                                                    <div class="row">
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            ...
                            if (resp != null){
                               ...
                               $("#DU-tgl_perjanjian").val(tglIndo(resp['tgl_perjanjian'])),
                               ...
                               $("#DU-nominal_hutang").val(returntoM(resp['nominal_hutang'])),
                               $("#DU-nominal_tanggung").val(returntoM(resp['nominal_tanggungan'])),
                        ...
                        success: function (resp)
                        {
                            ...
                            //fixed
                                $(".tp-pihak").each(function(){
                                    ...
                                    {
                                        case "1":
                                            $(this).html("Pihak Yang Mengalihkan");
                                            break;
                                        case "2":
                                            $(this).html("Pihak Yang Menerima");
                                            break;
                                    }
                                })
