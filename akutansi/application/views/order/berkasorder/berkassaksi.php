                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-no_leg" class="form-control" title="* " value="<?php echo $no_akta ?>" required disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl Legalisasi </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_leg" class="form-control myDate" title="* " required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  id="DU-sifat_leg" class="form-control area" required></textarea>
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="TP-nama" class="form-control"  required>
                                                    </div>                                                    
                                                    <div class="form-group">
                                                        <label>Identitas Pihak </label><font color="red">*</font>
                                                        <textarea id="TP-identitas" class="form-control area"  required></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Catatan </label>
                                                        <textarea id="TP-catatan" class="form-control area"  ></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-2">
                                                            <input type="submit" class="btn btn-primary" value="Simpan"> 
