...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Waarmarking | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>No Waarmarking </label><font color="red">*</font>
                                                        <input type="text" id="DU-no_waar" class="form-control" value="<?php echo $no_akta ?>" required disabled rel="tooltip" title="*Wajib Diisi. <br/>Isi No surat waarmerking sama dengan No Surat saat tambah order.<br/> (Akan muncul di dalam laporan)">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tgl Surat </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_surat" class="form-control myDate" rel="tooltip" title="* Wajib diisi.<br/> Tanggal surat yang tertera dalam surat yang di waarmerking. (Akan muncul dalam laporan).<br/> *) Gunakan 2, 4, atau 6 digit angka.<br/> .">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Tgl Daftar </label><font color="red"> *</font>
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_daftar" class="form-control myDate" rel="tooltip" title="* Wajib diisi.<br/> Tanggal didaftarkannya surat. (Akan muncul dalam laporan). <br/> *) Gunakan 2, 4, atau 6 digit angka.<br/> ">
                                                            <span class="input-group-addon ">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  id="DU-sifat_waar" class="form-control area" rel="tooltip" title="*Wajib Diisi. <br/> Diisi catatan singkat perihal atau isi perjanjian. Bisa disamakan dengan sifat surat."></textarea>
                                                    </div>
                                                    <div class="row">
        ...
        <script>
                ...
                function getDU()
                {
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            resp = resp['Data'][0];
                            if (resp != null){
                                $("#DU-no_waar").val(resp['no_waar'])
                                $("#DU-tgl_surat").val(tglIndo(resp['tgl_surat']))
                                $("#DU-tgl_daftar").val(tglIndo(resp['tgl_daftar']))
                                $("#DU-sifat_waar").val(resp['sifat_waar'])
                            }
                        }
                    })
                    return false;   
            ...
            //insert
                ...
                $("#DU").submit(function(){
                    ...
                    if (cek == "sukses"){
                        param = {'id_order'         : "<?php echo $id_order ?>",
                                 'no_waar'   : $("#DU-no_waar").val(),
                                 'tgl_surat'   : formatDate($("#DU-tgl_surat").val()),
                                 'tgl_daftar'   : formatDate($("#DU-tgl_daftar").val()),
                                 'sifat_waar'   : $("#DU-sifat_waar").val(),
                ...
                {
                        nowaar = $("#DU-no_waar").val();
                        tglsurat = $("#DU-tgl_surat").val();
                        tgldaftar = $("#DU-tgl_daftar").val();
                        sifat = $("#DU-sifat_waar").val();

                        kondisi = "";
                        if((nowaar != "") && (tglsurat != "") && (tgldaftar != "") && (sifat != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function cekfocus_du()
                {
                    if ($("#DU-no_waar").val() == ""){
                        ...
                        $("#DU-tgl_surat").focus();
                    }else if($("#DU-tgl_daftar").val() == ""){
                        $("#DU-tgl_daftar").focus();
                    }else if ($("#DU-sifat_waar").val() == ""){
                        $("#DU-sifat_waar").focus();
                    }
