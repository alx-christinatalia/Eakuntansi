...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Perubahan PT | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="base-content">
                        <div class="row">
                            <div class="col-md-12" id="notifikasi"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-hover table-striped table-bordered table-detail">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="io-bdnhumun_namausaha"><?php echo $bdn_usaha; ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Deskripsi</th>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="NBU-id" class="hide">
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  id="DU-jml_saham_disetor" rel="tooltip" onfocus='toN(this);' onblur='toM(this);'  class="form-control" title="* Wajib diisi.<br/> Jumlah saham disetor. Konversi saham dari jumlah modal disetor.<br/>Contoh : 20">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Bidang Usaha </label><font color="red">*</font>
                                                        <textarea type="text"  id="DU-bidang" rel="tooltip"  class="form-control" title="* Wajib diisi.<br/>Pisahkan dengan koma (;) untuk setiap bidang usaha.<br/> Contoh : Bidang perdagangan; jasa; konsultansi.Jika utk yayasan diisi dg nilai 'maksud dan tujuan'."></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Alamat Perseroan </label><font color="red">*</font>
                                                        <input type="text"  id="DU-alamat" rel="tooltip"  class="form-control" title="* Wajib diisi.<br/>Diisi alamat Badan Usaha.<br/>Contoh : Jl. Soekarno Hatta 15 D">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-kabkota_nama" class="hide">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Keterangan </label><font color="red">*</font>
                                                        <textarea type="text"  id="DU-ket" rel="tooltip"  class="form-control" title="* Wajib diisi.<br/>Diisi keterangan singkat tentang perubahan anggaran dasar badan hukum."></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Jangka Waktu </label><font color="red">*</font>
                                                        <select type="text" id="DU-jangka_waktu" rel="tooltip"  class="form-control" title="* Wajib diisi.<br/> Jangka waktu berdirinya badan hukum, Terbatas atau Tidak terbatas" >
        ...
        <script>
            ...
            //getData
                ...
                function getDU()
                {
                    ...
                    $.ajax({
                        ...
                        success: function (resp)
                        {
                            resp = resp['Data'][0];
                            if (resp != null){
                                var example = $("#DU-kabkota_id").select2();
                                $("#DU-modaldasar").val(returntoM(resp['modal_dasar']))
                                $("#DU-jml_saham").val(returntoM(resp['jml_saham']))
                                $("#DU-jml_saham_nominal").val(resp['jml_saham_nominal'])
                                $("#DU-modal_disetor").val(returntoM(resp['modal_disetor']))
                                ...
                                example.val(resp['kabkota_id']).trigger('change');
                                $("#DU-kabkota_nama").val(resp['kabkota_nama'])
                                $("#DU-ket").val(resp['ket'])
                                $("#DU-jangka_waktu").val(resp['jangka_waktu'])
                                modal_disetor();
                            }else{
                                $("#notifikasi").html(alertShow("alert-danger", "Warning : Data perubahan masih kosong. Jika data pendirian badan hukum sudah ada sebelumnya. Silahkan ambil data <a href=\"#m_order\" onclick=\"ref_order();\" data-toggle=\"modal\">klik disini</a>"));
                            }
                        }
                    })
                    return false;   
                ...
                function getKota()
                {
                    $("#DU-kabkota_nama").html("<option value=''>--- Pilih ---</option>");
                    $.ajax({
                        type:'post',
                        url:'<?php echo base_url('order/kotanotaris') ?>',
                        dataType: 'json',
                        success : function(result){
                            $("#DU-kabkota_id").html(result);
                        }
                    })
                }

                $("#DU-kabkota_id").change(function(){
                    var param = {
                                 "id_kabkota" : $("#DU-kabkota_id option:selected").val()
                                }
                     $.ajax({
                      type : "post",
                      ...
                      dataType: 'json',
                      success : function(result){
                        $('#DU-kabkota_nama').val(result["kota"]);
                      }
                    });
                })
            ...
            //insert
                ...
                $("#DU").submit(function(){
                    ...
                    if (cek == "sukses"){
                        param = {'id_order'         : "<?php echo $id_order ?>",
                                 ...
                                 'jml_saham_disetor': returntoN($("#DU-jml_saham_disetor").val()),
                                 ...
                                 'kabkota_nama'     : $('#DU-kabkota_id option:selected').html(),
                                 'ket'              : $("#DU-ket").val(),
                                 'jangka_waktu'     : $("#DU-jangka_waktu option:selected").val(),
                                 'layanan'          : '12',
                                 'layanan_nama'     : 'Perubahan PT'}
                ...
                function before_simpan_du()
                {
                        ...
                        kedudukanperseroan = $("#DU-kabkota").val();
                        kedudukankabkota = $("#DU-kabkota_id").val();
                        keterangan = $("#DU-ket").val();
                        jangkawaktu = $("#DU-jangka_waktu").val();
                        alamat = $("#DU-alamat").val();

                        kondisi = "";
                        if((modaldasar != "") && (jumlahsaham != "") && (modaldisetor != "") && (sahamygdisetor != "") && (bidangusaha != "") && (tujuanusaha != "") && (kedudukanperseroan != "") && (kedudukankabkota != "") && (jangkawaktu != "") && (keterangan != "") && (alamat != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                function cekfocus_du()
                {
                    if($("#DU-modaldasar").val() == ""){
                        ...
                        $("#DU-alamat").focus();
                    }else if ($("#DU-kabkota").val() == ""){
                        $("#DU-kabkota").focus();
                    }else if($("#DU-kabkota_id").val() == ""){
                        $("#DU-kabkota_id").focus();
                    }else if ($("#DU-ket").val() == ""){
                        $("#DU-ket").focus();
                    }else if($("#DU-jangka_waktu").val() == ""){
            ...
            //DU
                //Hitung
                    ...
                    $("#DU-modaldasar").keyup(function(){
                        jml_saham();
                        modal_disetor();
                        init = ($("#DU-modaldasar").val() * 25)/100;
                        $("#DU-modal_disetor").val(init);
                    })
        ...
        <script>
            var m_kywd="" , m_utama ="", m_table="", m_flt="";
            function get_modal_data(m_kywd, m_hal , m_utama, m_table, m_flt)
            {
                ...
                console.log("hal: "+m_hal+" kywd: "+m_kywd);
                   $.ajax({
                        ...
                        data: {param : {"page":m_hal, "kywd":m_kywd}, flt : m_flt},
                        dataType: "json",
                        success: function (result) {
            ...
            function set_order(selector)
            {
                id = $(selector).attr("data-id");
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url('berkasorder/perubahan_PT/getperubahan') ?>",
                        data : {id : id, idpeb : <?php echo $id_order ?>},
                        dataType: 'json',
                        success : function (result){
                            if(result == "sukses"){ 
                                $("#DU-kabkota_id").select2();  
            ...
            function ref_order()
            {
                get_modal_data("", "" , "umum/data_order", "#list-order","Pendirian PT");
            }

            $("#form-search-order").submit(function(){
                search_data = $("#s-order").val();
                get_modal_data(search_data, "" , "umum/data_order", "#list-order");   
                return false;
            })
        </script>
        <script>
