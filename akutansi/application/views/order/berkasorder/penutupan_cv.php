...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Penutupan CV | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                                                ...
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-medium date date-picker" >
                                                            <input type="text" class="form-control myDate" rel="tooltip" id="DU-tgl_berdiri" title="* Wajib diisi.<br />Tanggal berdiri. Format yyyy-mm-dd<br/> Contoh : 2014-02-15">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="TP-nama" rel="tooltip" class="form-control" title="* Wajib diisi.<br/>Nama pengurus.<br/>Contoh : Bagus Abdurrahman, ST">
                                                    </div>
                                                    <div class="form-group">
        ...
        <script>
            ...
            //insert
                ...
                {
                        alamat = $("#DU-alamat").val();
                        kedudukanp = $("#DU-kabkota").val();
                        kedudukank = $("#DU-kabkota_id").val();
                        tglberdiri = $("#DU-tgl_berdiri").val();
                        noakta = $("#DU-noakta_berdiri").val();
                        nama = $("#DU-notaris_lama").val();

                        kondisi = "";
                        if((alamat != "") && (kedudukanp != "") && (kedudukank != "") && (tglberdiri != "") && (noakta != "") && (nama != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
                ...
                $("#TP").submit(function(){
                        ...
                        if (cek == "sukses"){
                            ...
                            {
                                $(this).ajaxSubmit({
                                url: '<?php echo base_url('efiling/order_penutupan_pt') ?>',
                                type: 'POST',
                                data : {param:param},
                                dataType: 'json',
                                success: function(resp) {
