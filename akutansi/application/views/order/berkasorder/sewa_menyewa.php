...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Berkas Sewa Menyewa | eNotaris.com</title>
                                        ...
                                        <form id="DU" onsubmit="return false">
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Keterangan Obyek</label><font color="red"> *</font>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-bayar" class="form-control myMoney" rel="tooltip" title="Nominal yang sudah dibayar, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Jangka Waktu </label><font color="red"> *</font>
                                                        <input type="text" id="DU-jangka_waktu" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Jangka waktu pelunasan.<br/>Contoh : 36 Bulan">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" id="DU-tgl_batas" class="form-control myDate" rel="tooltip" title="* Wajib diisi.<br/>Batas akhir dari sewa-menyewa.<br />Tanggal batas. Format dd-mm-yyyy<br/> Contoh : 12-02-2014">
                                                            <span class="input-group-addon ">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="DU-ganti_rugi" class="form-control myMoney" rel="tooltip" title="Nominal ganti rugi, format penulisan tanpa titik(.)<br/> Contoh : 1000000 akan terformat 1.000.000">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Domisilli Pengadilan </label><font color="red">*</font>
                                                        <input type="text" id="DU-domisili" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Kantor Kepaniteraan .<br/>Contoh : Pengadilan Negeri di Kabupaten Malang">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pihak Pembayaran </label><font color="red">*</font>
                                                ...
                                                <div class="col-md-7 col-md-offset-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="TP-pihak_alias" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Pihak alias.">
                                                            <option value="1">Pihak Pertama (Pemilik)</option>
                                                            <option value="2">Pihak Kedua (Penyewa)</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
        ...
        <script>
            ...
            //insert
                ...
                function before_simpan_du()
                {
                        ...
                        kondisi = "";
                        if((obyek != "") && (ket != "") && (harga != "") && (batas != "") && (waktu != "") && (mulai != "") && (domisili != "") && (pembayar != ""))
                        {
                            kondisi = "sukses";
                        }else
                        {
