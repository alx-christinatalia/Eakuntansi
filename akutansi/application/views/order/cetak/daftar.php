  ...
  <html><head id="Head1">
      <title>
         Laporan Daftar Order | eNotaris.com
      </title>
        ...
        <table width="100%" style="border-bottom :1px solid black">
            <tbody>
                <tr>
                    ...
                    <td align="right"><img src="<?php echo base_url() ?>/assets/img/logo/print.png" alt="" /></td>
                </tr>
            </tbody>
        </table>
    </div>
    <div style="margin: 10px 5px;">
        <p style="text-align :center; font-size:20px; font-weight :bold ;">Daftar Order</p>
    </div>
        ...
        <table width='60%'>
            <tbody>
                <tr>
                    ...
                    <td width='20px'>:</td>
                    <td><?php echo ($param['tgl_order'] == "" ? " - " : $param['tgl_order']) ?></td>
                </tr>
                <tr>
                    <td width='150px'>Nama Officer</td>
                    <td width='20px'>:</td>
                    <td><?php echo ($param['nama_officer'] == "" ? " - " : $param['nama_officer']) ?></td>
                </tr>
                <tr>
                    <td width='150px'>Layanan</td>
                    <td width='20px'>:</td>
                    <td><?php echo ($param['layanan'] == "" ? " - " : $param['layanan']) ?></td>
                </tr>
                <tr>
                    <td width='150px'>Klien</td>
                    <td width='20px'>:</td>
                    <td><?php echo ($klien == "" ? " - " : $klien) ?></td>
                </tr>
            </tbody>
        </table>
    </div><br/>
        ...
        <table class='table table-bordered' width='100%'>
            <thead>
                <tr>
                    ...
                    <th width='50px'>No Order</th>
                    <th width='230px'>Klien</th>
                    <th width='20%'>Layanan</th>
                    <th width='20%'>Deskripsi</th>
                    <th width='70px'>No Akta</th>
                    <th width='80px'>No Berkas</th>
                </tr>
            </thead>
            <tbody>
            <?php $i=1 ?>
            <?php foreach ($data->Data as $resp) { ?>
                <tr>
                    ...
                    <td style='text-align:center;'><?php echo date("d-m-Y", strtotime($resp->tgl_order)); ?> </td>
                    <td style='text-align:center;'><?php echo $resp->_id ?></td>
                    <td><?php echo $resp->nama_klien ?></td>
                    <td><?php echo $resp->nama_layanan ?></td>
                    <td><?php echo $resp->deskripsi ?></td>
                    <td><?php echo $resp->no_akta ?></td>
                    <td><?php echo $resp->no_berkas ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
