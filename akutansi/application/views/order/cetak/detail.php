...
<html>
  <html>
   <head id="Head1">
      <title>
         Laporan Detail Order | eNotaris.com
      </title>
    ...
    <div style="margin: 10px 5px;">
        <p style="text-align :center; font-size:20px; font-weight :bold ;">Detil Order</p>
    </div>
        ...
        <table width='60%'>
            <tbody>
                ...
                <tr>
                    <td>Klien</td>
                    <td>:</td>
                    <td><b><?php echo $data->nama_klien ?></b></td>
                </tr>
                <tr>
                    <td>Layanan</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Status</td>
                    <td>:</td>
                    <td><?php echo ($data->is_closed == "1" ? "Closed" : "Open") ?></td>
                </tr>
                <tr>
                    <td>Buat Akta</td>
                    <td>:</td>
                    <td><?php echo ($data->sdh_buatakta == "1" ? "Sudah" : "Belum") ?></td>
                </tr>
                <tr>
                    <td>Sudah Cetak AKta</td>
                    <td>:</td>
                    <td><?php echo ($data->sdh_cetakakta == "1" ? "Sudah" : "Belum") ?></td>
                </tr>
                <tr>
                    <td>Biaya</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Total Tagihan</td>
                    <td>:</td>
                    <td class="uang"><?php echo $tagihan ?></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <table class='table-list' width='100%'>
        <thead>
            <tr>
                <th>Proses</th>
                <th width='20%' style='padding-right:5px; text-align:right;'>Biaya</th>
                <th width='100' style='text-align:center;'>Selesai</th>
                <th width='100' style='text-align:center;'>Diambil</th>
                <th width='100'>Tgl Diambil</th>
    ...
    <table class='table-list' width='100%'>
        <thead>
            <tr>
                ...
                <th>Uraian</th>
                <th>Jenis</th>
                <th style='padding-right:5px; text-align:right;'>Jumlah</th>
            </tr>
        </thead>
        <tbody>
        <?php 
        	if($data->sdh_billing == "1") 
        	{
        		foreach ($billing->Data as $resp) { 
		?>
	            <tr>
	                <td><?php echo date("d-m-Y", strtotime($resp->tgl)) ?></td>
