<?php
$OrDok = $dataOrder->Data[0]; // order Dokumen
?>
<!DOCTYPE html>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Tambah Dokumen | eNotaris.com</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    ...
                                    <div class="form-group text-center form-action">                                               
                                        <a class="btn btn-primary" onclick="simpan('1')" title="Simpan Data">
                                            <i class="fa fa-save"> +</i>
                                        </a>       
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="portlet light bordered">
                                    <div class="portlet-body">
                                        ...
                                        <input type="submit" id="subForm" class="hidden">
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Dokumen  <font color="red">*</font></label>
                                                        <input type="text"  name="" id="nama" rel="tooltip"  class="form-control" title="* Wajib diisi.<br/>Nama dokumen yang wajib disertakan dalam setiap layanan.<br/>Contoh : KTP; NPWP; SIUP;Surat Kuasa; BPKB. Diisi satu persatu.">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  id="penerima" rel="tooltip"  class="form-control" title="* Tidak  Wajib diisi.<br/>Nama petugas penerima di Kantor Notaris/PPAT.<br/>Contoh : Eno Tari" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Diambil</label>
                                                        <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  id="pengambil" rel="tooltip"  class="form-control" title="* Tidak  Wajib diisi.<br/>Nama pengambil dari pihak Klien.<br/>Contoh : Rahmat Sasmito" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Catatan </label>
                                                        <textarea type="text"  id="catatan" rel="tooltip"  class="form-control area" title="* Tidak  Wajib diisi.<br/> Bisa diisi dengan catatan kondisi atau posisi Dokumen<br/>Contoh : Dokumen berada di Kantor Notaris/PPAT" ></textarea>
                                                    </div>
                                                    <div class="form-group form-md-checkboxes">
                                                        <label class="control-label"  style="color: black">Status</label>
                                                        <div class="md-checkbox-inline">
                                                            <div class="md-checkbox">
                                                                <input type="checkbox" id="status" rel="tooltip" class="md-check">
                                                                <label for="status">
                                                                    <span class="inc"></span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-2">
                                                            <a type="submit" class="btn btn-primary tunggu btnLogin" onclick="simpan('0')" title="Simpan Data" >Simpan</a>
                                                        </div>
                                                        <div class="col-xs-4 col-md-3">
                                                            <a type="submit" class="btn btn-primary btnHide tunggu " onclick="simpan('1')" title="Simpan Data" >Simpan +</a>
                                                        </div>
                                                        <div class="col-xs-4 col-md-3">
                                                            <a class="btn default hilang btnHide" href="<?php echo base_url(); ?>order" title="Kembali ke halaman Order"> Batal
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script>
            $("#save_data").submit(function () {
                if ($("#nama").val() != null && $("#nama").val() != ""){
                    ...
                    param = {"id_order"     : "<?php echo $OrDok->_id ?>",
                             "nama"         : $("#nama").val(),
                    ...
                    $.ajax({
                        url:"<?php echo base_url('order/tambahdokumen') ?>",
                        type:'post',
                        data:{param:param},
                        dataType:'json',
                        success:function(resp){
                            ...
                            console.log(param)
                            ($("#simMethod").val()=="1" ?  location.reload() : location.href = "<?php echo base_url('order/orderdokumen/'.$OrDok->_id) ?>")
                        }
                    })
                }else{
