                                            ...
                                            <div class="row">
                                                ...
                                                <div id="notifikasi"></div>
                                                   <div class="form-group">
                                                        ...
                                                        <input type="text" name="npwp" id="npwp" rel="tooltip" class="form-control" title="* Wajib diisi. <br>Nomor Pokok Wajib Pajak.">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Nama <font color="red">*</font></label>
                                                        <input type="text" name="nama" id="nama" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>Nama sesuai nama si wajib pajak."  >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Alamat <font color="red">*</font></label>
                                                        <textarea name="alamat" id="alamat" rel="tooltip" class="form-control" title="* Wajib diisi. <br>Alamat sesuai alamat si wajib pajak." rows="2" =""></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Desa/Kelurahan <font color="red">*</font></label>
                                                        <input type="text" name="kelurahan" id="kelurahan" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>Kecamatan sesuai kecamatan si wajib pajak."  >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>RT/RW <font color="red">*</font></label>
                                                        <input type="text" name="rtrw" id="rtrw" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>RT/RW sesuai RT/RW si wajib pajak."  >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kecamatan <font color="red">*</font></label>
                                                        <div class="input-group">
                                                            <input type="text" placeholder="Kecamatan" id="kec" name="kec" class="form-control" rel="tooltip" title="* Wajib diisi. <br>Kabupaten/Kota sesuai Kabupaten/Kota si wajib pajak." disabled> 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="kota" id="kota" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>Kota sesuai Kota si wajib pajak."  >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kode Pos</label>
                                                        <input type="text" id="kodepos" class="form-control" name="kodepos" rel="tooltip" title="* Tidak wajib diisi. <br>Atau isi sesuai dengan kode pos si wajib pajak.">
                                                    </div>
                                                    <div class="row">
        ...
        <script>
            //Simpan Data
                ...
                function simpan()
                {
                    ...
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>npwp/simpan",
                        data : {param : param},
                        dataType: 'json',
                        success : function (result){
                            if (result == "gagal"){
                ...
                function before_simpan()
                {
                    ...
                    if((npwp != "") && (nama != "") && (alamat != "") && (kec != "") && (kelurahan != "") && (rtrw != "") && (kabkota != "") && (tgl_input != ""))
                    {
                        kondisi = "sukses";
                    }else
                    {
