                                ...
                                <div class="portlet light bordered table-list">
                                    ...
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="desa" id="desa" rel="tooltip" title="* Wajib diisi. <br>Desa/Kelurahan sesuai Desa/Kelurahan si wajib pajak."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Kecamatan" class="form-control" rel="tooltip" name="kec" id="kec" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>Silahkan pilih kecamatan." disabled> 
                                                            <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="kota" id="kota" rel="tooltip" title="* Wajib diisi. <br>Kota sesuai Kota si wajib pajak."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Kode Pos</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="kodepos" id="kodepos" rel="tooltip" title="* Tidak wajib diisi. <br>Diisi Kode Pos."> 
                                            </div>
                                        </div>
                                    </form> 
                                    </div>
                                ...
                                <div class="portlet light bordered table-list">
                                    ...
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                    <input type="text" class="form-control" rel="tooltip" name="nop" id="nop" rel="tooltip" title="* Wajib diisi. <br>Nomor Objek Pajak (NOP)."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Ltk Tanah dan Bangunan <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="ltktb" id="ltktb" rel="tooltip" title="* Wajib diisi. <br>Letak Tanah dan Bangunan." rows="2"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnama" class="col-md-3 control-label">Desa/Kelurahan <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="desab" id="desab" rel="tooltip" title="* Wajib diisi. <br>Desa/Kelurahan sesuai Desa/Kelurahan si wajib pajak."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">RT/RW <font color="red">*</font></label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" name="rtrw" id="rtrw" rel="tooltip" title="* Wajib diisi. <br>RT/RW sesuai RT/RW si wajib pajak."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Kecamatan <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Kecamatan" class="form-control" rel="tooltip" name="kecb" id="kecb" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>Silahkan pilih kecamatan." disabled> 
                                                            <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Kab/Kota <font color="red">*</font></label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" name="kotab " id="kotab" rel="tooltip" title="* Wajib diisi. <br>Kab/Kota sesuai Kab/Kota si wajib pajak."> 
                                            </div>
                                        </div>
                                    </form> 
                                    </div>
                                ...
                                <div class="portlet light bordered table-list">
                                    ...
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="0" rel="tooltip" name="lt" id="lt" rel="tooltip" title="* Wajib diisi. <br>Diisi luas tanah."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnama" class="col-md-3 control-label">NJOP PBB / M2 <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="0" rel="tooltip" name="njoppbb" id="njoppbb" rel="tooltip" title="* Wajib diisi. <br>Diisi nilai NJOP pada saat terjadinya perolehan hak."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Luas x NJOP</label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="luasxnjop" id="luasxnjop" rel="tooltip" title="*Perhitungan otomatis." disabled> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Luas Bangunan <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="0" rel="tooltip" name="lb" id="lb" rel="tooltip" title="* Wajib diisi. <br>Diisi luas bangunan."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnama" class="col-md-3 control-label">PBB Bangunan / M2 <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="0" rel="tooltip" name="pbbb" id="pbbb" rel="tooltip" title="* Wajib diisi. <br>Diisi nilai NJOP pada saat terjadinya perolehan hak."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Luas x PBB</label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="luasxpbb" id="luasxpbb" rel="tooltip" title="*Perhitungan otomatis." disabled> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Total NJOP PBB</label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="totalnjoppbb" id="totalnjoppbb" rel="tooltip" title="*Perhitungan otomatis." disabled> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnama" class="col-md-3 control-label">Harga Transaksi <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="0" rel="tooltip" name="ht" id="ht" rel="tooltip" title="* Wajib diisi. <br>Diisi nilai perolehan / harga jual."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                    <input type="text" class="form-control" rel="tooltip" name="ns" id="ns" rel="tooltip" title="* Wajib diisi. <br>Diisi no sertifikat tanah / bangunan."> 
                                            </div>
                                        </div>
                                    </form> 
                                    </div>
                                ...
                                <div class="portlet light bordered table-list">
                                    ...
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="0" rel="tooltip" name="npop" id="npop" rel="tooltip" title="* Wajib diisi. <br>Nilai perolehan objek pajak. Jika NJOP > NPOP maka yang digunakan adalah NJOP (berlaku mana yang nilainya lebih besar)."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="npoptkp" id="npoptkp" rel="tooltip" title="* Wajib diisi. <br>Nilai perolehan objek pajak tidak kena pajak . Tarif masing-masing wilayah berbeda. Nilai maksimal 60jt dan 300jt untuk NPOPTKP waris / hibah ."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="0" rel="tooltip" name="jp1" id="jp1" rel="tooltip" title="* Wajib diisi. <br>Jumlah pembayaran."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Kabupaten/Kota" class="form-control" rel="tooltip" name="lp" id="lp" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>Kota tempat pembayaran." disabled> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="naman" id="naman" rel="tooltip" title="* Wajib diisi. <br>Nama notaris / PPAT."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnama" class="col-md-3 control-label">Nama Wajib Pajak <font color="red">*</font></label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="namaw" id="namaw" rel="tooltip" title="* Wajib diisi. <br>Nama wajib pajak."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="md-radio-list">
                                                    ...
                                                    <div class="form-group hide" id="in2">
                                                        <div class="col-md-6">
                                                            <input type="text" id="nmr" name="nmr" class="form-control" placeholder="Nomor">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <input type="text" id="tglnmr" name="tglnmr" class="form-control" required>
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-calendar"></i>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="form-group hide" id="in3">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" placeholder="Pengurangan BPHTB" class="form-control" name="inbphtb" id="inbphtb" class="form-control" disabled> 
                                                                        <span class="input-group-btn">
                                                    ...
                                                    <div class="form-group hide" id="in4">
                                                        <div class="col-md-12">
                                                                <input type="text" placeholder="Sebutkan" class="form-control" name="isi" id="isi" class="form-control" required=""> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="npopkp" id="npopkp" rel="tooltip" title="*Perhitungan otomatis." disabled> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">BPHTB</label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="bphtb" id="bphtb" rel="tooltip" title="*Perhitungan otomatis." disabled> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Pengenaan 50%</label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="p50" id="p50" rel="tooltip" title="*Perhitungan otomatis." disabled> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-3 control-label">Bea Perolehan</label>
                                            <div class="col-md-6">                                                
                                              <input type="text" class="form-control" rel="tooltip" placeholder="0" name="bp" id="bp" rel="tooltip" title="*Perhitungan otomatis." disabled> 
                                            </div>
                                        </div>
                                    </form> 
                                    </div>
        ...
        <script>
            ...
            function set_notaris(){
             ...
             $("#js").change( function(){
                ...
                var radio = $( "#js option:selected").val();
                console.log(radio);
        ...
        <script>
            //Simpan Data
                ...
                function simpan()
                {
                    ...
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>ssb/simpan",
                        data : {param : param},
                        dataType: 'json',
                        success : function (result){
                         console.log(result['Output']);
                         buatssb(parseInt(result['Output']));
                        }
                    });
                }
                ...
                function buatssb($id)
                {
                    ...
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>ssb/asimpan/"+$id,
                        dataType: 'json',
                        success : function (result){    
                            var hasil = console.log(result);
                            ($("#idsimpan1").val() == "1" ? window.location.href = "<?php echo base_url(); ?>ssb" : "");
                            ($("#idsimpan2").val() == "1" ? location.reload() : "");
                            ($("#idsimpanatas").val() == "1" ? window.location.href = "<?php echo base_url(); ?>ssb" : "");
