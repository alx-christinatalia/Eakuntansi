...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari Data Pajak SSB..." value="<?php echo $this->input->post("kywd"); ?>" name="kywd" id="kywd" class="form-control" autofocus> 
                                    ...
                                    <div class="form-group text-center form-action">
                                        <a href="<?php echo base_url("ssb/tambah"); ?>" class="btn btn-primary" title="Tambah Pajak SSB">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Map</label>
                                                        <div class="input-group">
                                                            <input type="text" placeholder="Kode Map" id="map1" class="form-control" disabled> 
                                                                <span class="input-group-btn">
                    ...
                    <?php $this->load->view("pajak/ssb/modal/bayar"); ?>
                    <div class="hidden">
                        <form name="cetakdatassb" method="POST" target = '_blank' action="<?php echo base_url(); ?>ssb/cetakdatassb">
        ...
        <?php $this->load->view("pajak/ssb/modal/hapus"); ?>
        <?php $this->load->view("pajak/ssb/modal/npwp"); ?>
        <?php $this->load->view("pajak/ssb/modal/map"); ?>
        <?php $this->load->view("pajak/ssb/modal/bayar"); ?>
        ...
        <script type="text/javascript">
            ...
            //basic
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "/index.php/ssb";
            ...
            $("#filter-form").submit(function() {
                ...
                filter = {"npwp" : npwp, "ssb" : ssb, "byr" : byr, "tgl_mulai":tgl_mulai}
                loadTable( "#list-data" ,kywd, page, limit, filter, utama, 7);
                return false;
            });
        ...
        <script>
            function bayarData(selector) {
              ...
              function _update(){
                ...
                $.ajax({
                    type : "post",
                    url : "<?php echo base_url(); ?>index.php/ssb/update/"+_id,
            ...
            function hapusData(selector) {
                ...
                $("#btnDelete").attr("href", base_url + "/index.php/ssb/delete/" + id);
            ...
            function cetakData(selector) {
                ...
                document.forms['cetakdatassb'].submit();
        ...
        //fungsi menekan search modal
            ...
            function ref_map()
            {
                get_modal_data("", "" , "ssb/datamap", "#list-map");
            }
        </script>
        ...
        var m_kywd="" , m_utama ="", m_table="";
             ...
             $("#frmmap").submit(function() {
                ...
                get_modal_data(search_data, "" , "ssb/datamap", "#list-map");   
                return false;
            ...
            function get_map(kywd, hal )
            {
                ...
                console.log("hal: "+hal+" kywd: "+kywd);
                   $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>ssb/datamap",
                        data: {param : {"page":hal, "kywd":kywd}},
                        dataType: "json",
                        success: function (result) {
