...
<html>
	...
	<body style="font-size: 10">
		<table  width="720px">
			...
			<tr>
				<td colspan="3" align="center"><h2>Pengurangan BPHTB</h2></td>
			</tr>
			<tr>
				<td colspan="3">
					<table height="250" width="535" border="1" class="garis">
						<tr class="garis">
							<td>No</td>
							<td>Kode</td>
							<td>Alasan Pengurang</td>
							<td>Persentase</td>
							<td>Status</td>
						</tr>
							<?php $no =0; ?>
							<?php foreach ($penguranganbphtb->Data as $result) { 
						...
						<tr class="garis">
							...
							<td><?php echo $result->alasan; ?></td>
							<td><?php echo $result->prosentase; ?></td>
							<td><?php echo $a; ?></td>
						</tr>
							<?php } ?>
					</table>
