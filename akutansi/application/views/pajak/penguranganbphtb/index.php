...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            <?php $this->load->view("template/sidebar", ["active" => "pajak", "sub" => "penguranganbphtb"]); ?>
            <!-- BEGIN CONTENT -->
            ...
            <!-- BEGIN CONTENT BODY -->
                ...
                <!-- BEGIN PAGE HEAD-->
                                    ...
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari Kode, Alasan, Persentase..." value="<?php echo $this->input->post("kywd"); ?>" name="kywd" id="kywd" class="form-control" autofocus> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="fprosentase" >
                                                                <option value="">Pilih Persentase</option>
                                                                    <?php foreach($ssb->Data as $data) {
                                                                        echo "<option value='$data->prosentase'>$data->prosentase</option>"; 
                                                                    } ?>
                                                            </select> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="fsort">
                                                                ...
                                                                <option value="alasan asc">Alasan Asc</option>
                                                                <option value="alasan desc">Alasan Desc</option>
                                                            </select>
                                            ...
                                            <table class="table table-responsive table-striped" style="margin-bottom: 0px;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 40%;">Alasan Pengurang</th>
                    ...
                    <div class="hidden">
                        <form name="form_cetak" method="POST" action="<?php echo base_url(); ?>/index.php/penguranganbphtb/cetakpenguranganbphtb">
                            <input type="hidden" name="kode" id="h_kode">
                            <input type="hidden" name="prosentase" id="h_prosentase">
        ...
        <script type="text/javascript">
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "/index.php/penguranganbphtb";
            ...
            $("#filter-form").submit(function() {
                ...
                var prosentase        = $("#fprosentase option:selected").val();
                var sort        = $("#fsort option:selected").val();
                var status        = $("#fstatus option:selected").val();

                filter = {"sort" : sort, "kode" : kode, "prosentase" : prosentase, "status" : status}
                loadTable( "#list-data" ,kywd, page, limit, filter, utama, 4);
                return false;
            });
