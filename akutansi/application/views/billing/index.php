...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Billing | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    ...
                                    <div class="form-group text-center form-action">    
                                        ...
                                        <a role="button" class="btn btn-primary " href="<?php echo base_url(); ?>billing/Form-Laporan" title="Print data klien">
                                            ...
                                            <table class="table table-responsive table-striped" style="margin-bottom: 0px;" style="text-align: left;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 10%;">Status Billing</th>
        ...
        <script type="text/javascript">
            ...
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "billing";
        ...
        //set data ke form
         ...
         //Confert Uang
                ...
                function toM2(selector)
                {
                    hargasatuan = $(selector).html();
                    
                        var number_string = hargasatuan.toString(), sisa  = number_string.length % 3, hargasatuan  = number_string.substr(0, sisa), ribuan  = number_string.substr(sisa).match(/\d{3}/g); if (ribuan) { separator = sisa ? '.' : ''; hargasatuan += separator + ribuan.join('.');}
                    $(selector).html(hargasatuan);
                }
