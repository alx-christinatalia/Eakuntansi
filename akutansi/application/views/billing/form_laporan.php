...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Laporan Billing | eNotaris.com</title>
                                            ...
                                            <table class="table table-responsive table-striped" style='cursor:pointer'>
                                                ...
                                                <tbody>
                                                    <tr class="in" onclick="aktif_daftar();" style="background: #dbdbdb">
                                                        <td>1</td>
                                                        <td>Daftar Billing</td>
                                                    </tr>
                                                    <tr class="in" onclick="aktif_detail();">
                                                        <td>2</td>
                                                        <td>Detail Billing</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>  
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject "> Filter Daftar Billing</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <form method="POST" target="_BLANK" action="<?php echo base_url('billing/cetak-daftar-billing'); ?>">
                                            <div class="row">
                                                ...
                                                <div class="col-md-1">
                                                    <div class="form-group" style="padding-top:25px;">
                                                        <a onclick="r_klien()" class="btn green-turquoise" title="reset">
                                                            <i class="fa fa-close"></i>
                                                        </a>
                                                    </div>
                                                    <div class="form-group" style="padding-top:25px;">
                                                        <a onclick="r_layanan()" class="btn green-turquoise" title="reset">
                                                            <i class="fa fa-close"></i>
                                                        </a>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-8" id="detail_klien">
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-filter"></i>
                                            <span class="caption-subject "> Filter Detail Billing</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <form method="POST" target="_BLANK" action="<?php echo base_url('billing/cetak-detail-billing'); ?>">
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div id="notifikasi"></div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-1">
                                                    <div class="form-group" style="padding-top:25px;">
                                                        <a onclick="r_order()" class="btn green-turquoise" title="reset">
                                                            <i class="fa fa-close"></i>
                                                        </a>
                                                    </div>
                                                </div>
