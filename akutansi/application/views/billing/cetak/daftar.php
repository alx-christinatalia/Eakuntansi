...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head id="Head1">
      <title>
         Laporan Daftar Billing | eNotaris.com
      </title>
   ...
   <body>
    ...
    <div style="margin: 10px 5px;">
        <p style="text-align :center; font-size:20px; font-weight :bold ;">Daftar Billing</p>
    </div>
    <table class='table-list' width='100%'>
        ...
        <tbody>
        <?php $i=1;
         foreach($order->Data as $resp) { ?>
            <tr>
                <td><?php echo $i++; ?></td>
                <td><?php echo $resp->tgl_order; ?></td>
                <td><?php echo $resp->_id; ?></td>
                <td><?php echo $resp->nama_klien ?></td>
                <td><?php echo $resp->deskripsi ?></td>
                <td style='text-align:right'><?php echo $tagihan[$resp->_id]; ?></td>
                <td><?php echo ($resp->is_closed == "0" ? "Open" : "Closed") ?></td>
            </tr>
        <?php } ?>
        </tbody>
    </table>
