            ...
            <div class="modal-body">  
                <div class="portlet light">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12 pull-right">
                        <a role="button" class="btn btn-primary disabled" data-page="0" onclick="prevPage(this);" id="btnPrev" title="Tampilkan data sebelumnnya">
                            <i class="fa fa-chevron-left"></i>
                        </a>                                                    
                        <a role="button" class="btn btn-primary disabled" data-page="0" onclick="nextPage(this);" id="btnNext" title="Tampilkan data berikutnya">
