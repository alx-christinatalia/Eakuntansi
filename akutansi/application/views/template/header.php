    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="<?php echo base_url(); ?>">
                <img src="<?php echo base_url("assets/img/logo-light.png") ?>" alt="logo" class="logo-default" style="padding-top: 5px;"/>
            </a>
