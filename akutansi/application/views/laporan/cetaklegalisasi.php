...
<html>
<head>
   <title>Daftar Surat Dibawah Tangan Disahkan (Legalisasi) | eNotaris.com</title>
   <style type="text/css">
         body {
         width: 1000px;
         margin-left: auto;
...
<body>
		<table  width="100%">
         ...
         <tr>
            <td colspan="3" align="center"><h2>Daftar Surat Dibawah Tangan Disahkan (Legalisasi)</h2></td>
         </tr>
         <tr>
         ...
         <tr>
            <td colspan="3">
               <table class="table-list" width="100%">
                  ...
                  <?php
                  	 $no=0;
                     foreach ($legalisasi->Data as $resp) { 
						$nama = array();
						$no++;
                  ?>
                     <tr class="garis"> 
                        ...
                        <td><?php echo date("d M Y", strtotime($umum[$resp->_id]->tgl_leg)); ?></td>
                        <td><?php echo $resp->sifat_akta; ?></td>
