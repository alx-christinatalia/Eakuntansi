...
<html>
<head>
   <title>Laporan Covernote | eNotaris.com</title>
   <style type="text/css">
         body {
         width: 1000px;
         margin-left: auto;
...
<body>
		<table  width="100%">
         ...
         <tr>
            <td colspan="3" align="center"><h2>Laporan Covernote</h2></td>
         </tr>
         <tr>
         ...
         <tr>
            <td colspan="3">
               <table class="table-list" width="100%">
                  ...
                  <?php
                     foreach ($covernote->Data as $result) {
                  ?>
                     <tr class="garis"> 
                        <td><?php echo $umum[$result->_id]->no_surat; ?></td>
                        <td><?php echo date("d-M-Y", strtotime($umum[$result->_id]->tgl_surat)); ?></td>
                        <td><?php echo $umum[$result->_id]->kepada; ?></td>
                        <td><?php echo $umum[$result->_id]->perihal; ?></td>
                        <td><?php echo $result->nama_officer; ?></td>
                     </tr>
                  <?php } ?>
               </table>
            </td>
