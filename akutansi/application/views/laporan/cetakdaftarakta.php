...
<html>
<head>
   <title>Daftar Akta(Repertorium) | eNotaris.com</title>
   <style type="text/css">
         body {
         width: 1000px;
         margin-left: auto;
...
<body>
		<table  width="100%">
         ...
         <tr>
            <td colspan="3" align="center"><h2>Daftar Akta(Repertorium)</h2></td>
         </tr>
         <tr>
         ...
         <tr>
            <td colspan="3">
               <table class="table-list" width="100%">
                  ...
                  <?php
                     foreach ($akta->Data as $result) { ?>
                     <tr class="garis"> 
                        <td><?php echo $result->no_repertorium; ?></td>
                        <td><?php echo date("d M Y", strtotime($result->tgl_closed)); ?></td>
                        <td><?php echo $result->sifat_akta; ?></td>
