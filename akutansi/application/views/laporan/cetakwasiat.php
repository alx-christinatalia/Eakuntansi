...
<html>
<head>
   <title>Laporan Wasiat | eNotaris.com</title>
   <style type="text/css">
         body {
         width: 1000px;
         margin-left: auto;
...
<body>
		<table  width="100%">
         ...
         <tr>
            <td colspan="3" align="center"><h2>Laporan Wasiat</h2></td>
         </tr>
         <tr>
            ...
            <td colspan="3">
               <table class="table-list" width="100%">
                     ...
                     <tr>
                        ...
                        <td align="center">Nama Dahulu</td>
                        <td align="center">Tempat Lahir</td>
                        <td align="center">Tgl Lahir</td>
                        <td align="center">Pekerjaan</td>
                        <td align="center">Alamat Terakhir</td>
                     </tr>
                  <?php
                  	 $no=0;
                     foreach ($wasiat->Data as $resp) {
                     $no++;
                  ?>
                     <tr class="garis"> 
                        <td><?php echo $no; ?></td>
                        <td><?php echo $pihak[$resp->_id]->nama; ?></td>
                        <td><?php echo $pihak[$resp->_id]->nama_dahulu; ?></td>
                        <td><?php echo $pihak[$resp->_id]->tmp_lahir; ?></td>
                        <td><?php echo date("d-M-Y", strtotime($pihak[$resp->_id]->tgl_lahir)); ?></td>
                        <td><?php echo $pihak[$resp->_id]->pekerjaan; ?></td>
                        <td><?php echo $pihak[$resp->_id]->alamat_terahir; ?></td>
                     </tr>
                  <?php } ?>
               </table>
            </td>
