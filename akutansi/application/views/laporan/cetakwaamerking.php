...
<html>
<head>
   <title>Daftar Surat Dibawah Tangan Didaftarkan (Waarmarking) | eNotaris.com</title>
   <style type="text/css">
         body {
         width: 1000px;
         margin-left: auto;
...
<body>
		<table  width="100%">
         ...
         <tr>
            <td colspan="3" align="center"><h2>Daftar Surat Dibawah Tangan Didaftarkan (Waarmarking)</h2></td>
         </tr>
         <tr>
            ...
            <td colspan="3">
               <table class="table-list" width="100%">
                     <tr>
                        ...
                        <td>Tgl Daftar</td>
                        <td>Sifat Surat</td>
                        <td>Nama Menandatangani</td>
                     </tr>
                  <?php
                  	 $no=0;
                     foreach ($register->Data as $resp) { 
						$nama = array();
						$no++;
                  ?>
                     <tr class="garis"> 
                        ...
                        <td><?php echo date("d M Y", strtotime($umum[$resp->_id]->tgl_surat)); ?></td>
                        <td><?php echo date("d M Y", strtotime($umum[$resp->_id]->tgl_daftar)); ?></td>
                        <td><?php echo $umum[$resp->_id]->sifat_waar; ?></td>
						<?php foreach($pihak[$resp->_id]->Data as $term){
						  $nama[] = $term->nama;
						} ?>
