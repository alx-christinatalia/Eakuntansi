...
<html>
<head>
   <title>Daftar Protes | eNotaris.com</title>
   <style type="text/css">
         body {
         width: 1000px;
         margin-left: auto;
...
<body>
		<table  width="100%">
         ...
         <tr>
            <td colspan="3" align="center"><h2>Daftar Protes</h2></td>
         </tr>
         <tr>
         ...
         <tr>
            <td colspan="3">
               <table class="table-list" width="100%">
                  ...
                  <?php
                     foreach ($protes->Data as $resp) {
                  ?>
                     <tr class="garis"> 
                        <td><?php echo date("d-M-Y", strtotime($umum[$resp->_id]->tgl_akta)); ?></td>
                        <td><?php echo $umum[$resp->_id]->no_akta; ?></td>
                        <td><?php echo $umum[$resp->_id]->sifat_akta; ?></td>
                        <td><?php echo $resp->nama_officer; ?></td>
