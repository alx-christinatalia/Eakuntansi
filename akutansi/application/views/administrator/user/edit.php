...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="notifikasi"></div>
                                                   <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama" id="nama" rel="tooltip" class="form-control" title="* Wajib diisi. <br>Nama user minimal 3 karakter. Contoh = Iza." value="<?php echo $user->Data[0]->nama; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Email <font color="red">*</font></label>
                                                        <input type="text" name="email" id="email" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>Email user. Contoh = emailuser@gmail.com." value="<?php echo $user->Data[0]->email; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>No Handphone <font color="red">*</font></label>
                                                        <input type="text" name="nohp" id="nohp" rel="tooltip"  class="form-control" title="* Wajib diisi. <br>No Handphone. Contoh = 081230163249." value="<?php echo $user->Data[0]->nohp; ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group form-md-checkboxes">
                                                        ...
                                                        <div class="md-checkbox-inline">
                                                            <div class="md-checkbox">
                                                                <input type="checkbox" id="cbstatus" class="md-check">
                                                                <label for="cbstatus">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" id="officer" name="officer" class="form-control" rel="tooltip" title="* Wajib diisi. <br>Pilih nama officer." disabled value="<?php echo $user->Data[0]->nama_officer; ?>"> 
                                                                <input type="hidden" id="id_officer" value="<?php echo $user->Data[0]->id_officer; ?>">
        ...
        <!-- END CONTAINER -->
        <div class="hidden">
            <input type="hidden" value="" id="indashboard">
            <input type="hidden" value="" id="inklien">
            <input type="hidden" value="" id="inorder">
            <input type="hidden" value="" id="inakta">
            <input type="hidden" value="" id="inproses">
            <input type="hidden" value="" id="insisminbakum">
            <input type="hidden" value="" id="inbilling">
            <input type="hidden" value="" id="inefiling">
            <input type="hidden" value="" id="inkeuangan">
            <input type="hidden" value="" id="inpajak">
            <input type="hidden" value="<?php echo $user->Data[0]->aktif; ?>" id="instatus">
        </div>
        ...
        <script type="text/javascript" language="javascript">
            $(document).ready(function() {
                $('#nama').focus();
                $('#level').val(<?php echo $user->Data[0]->is_admin; ?>);
                if ($('#instatus').val() == "1"){
                ...
                var number = "<?php echo $user->Data[0]->akses; ?>",
                    output = [];
                ...
                output[0] == "1" ? $("#cbdashboard").prop('checked', true) : $("#cbdashboard").prop('checked', false) ;
                output[1] == "1" ? $("#cbklien").prop('checked', true) : $("#cbklien").prop('checked', false) ;
                output[2] == "1" ? $("#cborder").prop('checked', true) : $("#cborder").prop('checked', false) ;
                output[3] == "1" ? $("#cbakta").prop('checked', true) : $("#cbakta").prop('checked', false) ;
                output[4] == "1" ? $("#cbproses").prop('checked', true) : $("#cbproses").prop('checked', false) ;
                output[5] == "1" ? $("#cbsisminbakum").prop('checked', true) : $("#cbsisminbakum").prop('checked', false) ;
                output[6] == "1" ? $("#cbbilling").prop('checked', true) : $("#cbbilling").prop('checked', false) ;
                output[7] == "1" ? $("#cbefiling").prop('checked', true) : $("#cbefiling").prop('checked', false) ;
                output[8] == "1" ? $("#cbkeuangan").prop('checked', true) : $("#cbkeuangan").prop('checked', false) ;
                output[9] == "1" ? $("#cbpajak").prop('checked', true) : $("#cbpajak").prop('checked', false) ;
            });
        </script>
        <script>
        ...
        <script>
            //Simpan Data
                ...
                function simpan()
                {
                    ...
                    var aksdashboard = ($("#cbdashboard").is(':checked') ? "1" : "0");
                    var aksklien = ($("#cbklien").is(':checked') ? "1" : "0");
                    var aksorder = ($("#cborder").is(':checked') ? "1" : "0");
                    var aksakta = ($("#cbakta").is(':checked') ? "1" : "0");
                    var aksproses = ($("#cbproses").is(':checked') ? "1" : "0");
                    var akssisminbakum = ($("#cbsisminbakum").is(':checked') ? "1" : "0");
                    var aksbilling = ($("#cbbilling").is(':checked') ? "1" : "0");
                    var aksefiling = ($("#cbefiling").is(':checked') ? "1" : "0");
                    var akskeuangan = ($("#cbkeuangan").is(':checked') ? "1" : "0");
                    var akspajak = ($("#cbpajak").is(':checked') ? "1" : "0");
                    var status = ($("#cbstatus").is(':checked') ? "1" : "0");   
                    var _id =  $("#id").val();
