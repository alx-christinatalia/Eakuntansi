	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="titleInUp">Edit Data Officer</h4>
			</div>
			<form class="save_data" id="edit-data">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								<label>Keterangan</label>
                                	<textarea class="form-control" id="ket-edit" required=""></textarea>
							</div>
							<div class="form-group">
								<label>Catatan</label>
                                	<textarea class="form-control" id="catatan-edit" required=""></textarea>
							</div>
							<div class="form-group">
								<label>Aktif</label>
