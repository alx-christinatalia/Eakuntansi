...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Master Notaris Dokumen | eNotaris.com </title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari : Info" name="kywd" id="kywd" class="form-control"> 
                                    ...
                                    <div class="form-group text-center form-action">
                                        <a href="<?php echo base_url("masternotarisdokumen/tambah"); ?>" class="btn btn-primary" title="Tambah Dokumen">
                    ...
                    <?php $this->load->view("administrator/masternotarisdokumen/modal/hapus"); ?>
        ...
        <script>
        //utama
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id asc"}, utama = "masternotarisdokumen";
        ...
        //delete
            ...
            function delete_now()
            {
                id = $("#delete-id").html();
                $.ajax({
                    url:"<?php echo base_url('masternotarisdokumen/deleteDokumen') ?>/"+id,
                    dataType:'json',
