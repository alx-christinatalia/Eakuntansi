...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>User Log | eNotrasi.com </title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            <?php $this->load->view("template/sidebar", ["active" => "administrator", "sub" => "userlog"]); ?>
        ...
        //utama
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "user_log";
