...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari Data Notaris Rekanan..." value="<?php echo $this->input->post("kywd"); ?>" name="kywd" id="kywd" class="form-control" autofocus> 
                                    ...
                                    <div class="form-group text-center form-action">
                                        <a href="<?php echo base_url("notarisrekanan/tambah"); ?>" class="btn btn-primary" title="Tambah Notaris Rekanan">
                                            ...
                                            <table class="table table-responsive table-striped" style="margin-bottom: 0px;" style="text-align: left;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 15%;">Wilayah Kerja</th>
                                                        <th style="width: 15%;">Alamat Kantor</th>
        ...
        <?php $this->load->view("administrator/notarisrekanan/modal/hapus"); ?>
        ...
        <script type="text/javascript">
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "/index.php/notarisrekanan";
            ...
            function hapusData(selector) {
                ...
                $("#btnDelete").attr("href", base_url + "/index.php/notarisrekanan/delete/" + id);
