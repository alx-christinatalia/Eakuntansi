                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="sknotaris" id="sknotaris" rel="tooltip" title="* Wajib diisi. <br>Alamat sesuai alamat si wajib pajak." rows="2"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-2 control-label">SK PPAT</label>
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="skppat" id="skppat" rel="tooltip" title="* Wajib diisi. <br>Alamat sesuai alamat si wajib pajak." rows="2"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnotelp" class="col-md-2 control-label">Alamat Kantor</label>
                                            <div class="col-md-6">
                                                <textarea class="form-control" rel="tooltip" name="alamatkantor" id="alamatkantor" rel="tooltip" title="* Wajib diisi. <br>Uraian Pembayaran berisi informasi tambahan  pembayaran."  rows="2"></textarea></div>
                                        </div>
                                        <div class="form-group">
        ...
        <script>
            //Simpan Data
                ...
                function simpan()
                {
                    ...
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>notarisrekanan/simpan",
                        data : {param : param},
                        dataType: 'json',
                        success : function (result){
