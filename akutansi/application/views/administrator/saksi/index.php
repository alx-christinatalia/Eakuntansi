...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            <?php $this->load->view("template/sidebar", ["active" => "administrator", "sub" => "saksi"]); ?>
                                    ...
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari Data Saksi..." value="<?php echo $this->input->post("kywd"); ?>" name="kywd" id="kywd" class="form-control" autofocus> 
        ...
        <?php $this->load->view("administrator/saksi/modal/tambah"); ?>
        <?php $this->load->view("administrator/saksi/modal/edit"); ?>
        <?php $this->load->view("administrator/saksi/modal/hapus"); ?>
        ...
        <script type="text/javascript">
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "saksi";
            ...
            function tambahData(selector) {
                $("#btnTambah").attr("href", base_url + "/index.php/saksi/simpan/");
                $("#tambah").modal("show");
                aktif = "0";
              ...
              function _update(){
                ...
                $.ajax({
                    type : "post",
                    url : "<?php echo base_url(); ?>index.php/saksi/update/"+_id,
            ...
            $("#save_data").submit(function() {
             ...
             function simpan(){
                ...
                $.ajax({
                    type : "post",
                    url : "<?php echo base_url(); ?>index.php/saksi/simpan",
                    data : {param : param},
                    dataType: 'json',
                    success : function (result){
                        if (result == "gagal"){
                           notifShow("error","Data sudah ada!"); 
            ...
            function hapusData(selector) {
                ...
                $("#btnDelete").attr("href", base_url + "/index.php/saksi/delete/" + id);
