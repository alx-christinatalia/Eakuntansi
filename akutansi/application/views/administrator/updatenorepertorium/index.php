...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Update No Repertorium | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            <?php $this->load->view("template/sidebar", ["active" => "administrator", "sub" => "updatenorepertorium"]); ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari Data Nomor Repertorium..." value="<?php echo $this->input->post("kywd"); ?>" name="kywd" id="kywd" class="form-control" autofocus> 
                                    ...
                                    <div class="form-group text-center form-action">                                     
                                        ...
                                        <a role="button" class="btn btn-primary" onclick="simpan();" data-page="1" id="btnsimpan" title="Update No Repertorium">
                    ...
                    <div class="base-content">
                        <div class="row">
                                            ...
                                            <table class="table table-responsive table-striped" style="margin-bottom: 0px;" style="text-align: left;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 20%;">Deskripsii</th>
                                                        <th style="width: 10%;">Status</th>
                                                        <th style="width: 20%;">No Repertorium</th>
                                                    </tr>
                                                </thead>
                            ...
                            <div class="col-md-11 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <input type="submit" class="btn btn-primary btnSave" onclick="simpan()" value="Simpan">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "/index.php/updatenorepertorium";
            ...
            function prevPage(selector) {
             ...
             function simpan(){
                $(".nomer").each(function (){
                    var param = {"no_repertorium" : $(this).val()}
                    var id = $(this).attr('id');
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>index.php/updatenorepertorium/update/"+id,
                        data : {param : param},
                        dataType: 'json',
