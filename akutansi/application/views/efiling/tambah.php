...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Tambah File | eNotaris.com</title>
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="notifikasi"></div>
                                                    <div class="form-group">
                                                        <label for="inputnama"  class="control-label">Jenis<font color="red">*</font></label>
                                                        <select class="form-control" id="jenis" rel="tooltip" title="* Wajib diisi. <br/>Jenis file yang akan anda upload.">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control Datainfo" rel="tooltip"  title="* Wajib diisi. <br/>Informasi berdasarkan jenis, dan dipilih dengan melalui tombol disebelah kanan.<br/> Contoh : Order => Info berisi No Ordernya" value="<?php echo $info; ?>" required disabled >
                                                            <input type="hidden" class="ref_sumber" id="" readonly required>
                                                            <input type="hidden" class="ref_id" value = "<?php echo $indexNomor; ?>" id="" readonly required>
                                                    ...
                                                    <div class="form-group">
                                                        <label  class="control-label">File<font color="red">*</font></label>
                                                        <div class="input-group">
                                                            <input type="file" name="image_file" class="form-control" rel="tooltip" title="* Wajib diisi.<br/>Kapasitas maksimum file 4MB. Dalam bentuk jpg, png, gif,doc,xls,pdf,txt, zip, rar<br/>Jika pada waktu edit tidak ada perubahan file, maka file dikosongi saja" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label  class="control-label">Catatan</label>
                                                            <input type="text" id="catatan" rel="tooltip" class="form-control" title="* Tidak wajib diisi.<br/>Catatan ringkas tentang files yang diupload" >
                                                    </div>
                                                    <div class="hide">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-4 col-md-3">
                                                            <a class="btn btn-primary " onclick="_simpan();" id="btnLogin" title="Simpan Data">
                                                            Simpan
                                                            </a> 
                                                        </div>
        ...
        <script>
            ...
            $(".save_data").submit(function(){
                ...
                //alert('here');
                 $(this).ajaxSubmit({
                    type:'post',
                    url:"<?php echo base_url('efiling/simpanEfiling2') ?>",
                    data:{param:param},
                    dataType:'json',
            ...
            function JenisDefault()
            {
                ...
                console.log(f)
                    ...
                    c.attr('value', '<?php echo $indexNomor; ?>')
            }
