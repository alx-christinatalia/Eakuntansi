...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>e-Filling (Kearsipan Elektronik)| eNotaris.com </title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari : Nama file" name="kywd" id="kywd" class="form-control"> 
                                    ...
                                    <div class="form-group text-center form-action">
                                        <a href="<?php echo base_url("efiling/tambah/".$indexNomor."/".$indexJenis); ?>" class="btn btn-primary" title="Tambah Dokumen">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="jenis">
                                                                ...
                                                                <option value="Konfrimasi Bayar">Konfrimasi Bayar</option>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="filter_sort">
                                                                ...
                                                                <option value="diupload desc">Tgl Upload Desc</option>
                                                                <option value="diupload asc">Tgl Upload Asc</option>
                                                                <option value="jenis desc">Jenis desc</option>
                                                                <option value="jenis asc">Jenis  Asc</option>
        ...
        <?php $this->load->view("efiling/modal/hapus") ?>
        <!--[if lt IE 9]>
        ...
        //utama
            //var page = 1, kywd = "<?php echo $indexNomor; ?>", limit = 10, utama = "efiling";
            var page = 1, kywd = "", limit = 10, utama = "efiling";
            //var f = "<?php echo $indexJenis ?>";
            //console.log(f)
            var filter = {"sort" : "_id desc",
                          "jenis":"<?php echo $indexJenis ?>",
                          "ref_id":"<?php echo $indexNomor; ?>",}
        ...
        <script >
            ...
            $("#filter-form").submit(function() {
                ...
                filter = {"sort" : sort, "diupload" : tgl, "jenis" : jenis}
                loadTable( "#list-data" ,kywd, page, limit, filter, utama, 8)
                return false;
            });
            ...
            function delete_now()
            {
                id = $("#delete-id").html();
                $.ajax({
                    url:"<?php echo base_url('efiling/deleteData') ?>/"+id,
                    dataType:'json',
