                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" role="form" id="save_data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" rel="tooltip" name="asalsurat" id="asalsurat" rel="tooltip" title="* Wajib diisi. <br>Dari siapa surat tersebut."> 
                                            </div>
                                        </div>
                                        <div class="form-group">
        ...
        <script>
            //Simpan Data
                ...
                function simpan()
                {
                    ...
                    $.ajax({
                        type : "post",
                        url : "<?php echo base_url(); ?>suratmasuk/simpan",
                        data : {param : param},
                        dataType: 'json',
                        success : function (result){
                            console.log(result);
