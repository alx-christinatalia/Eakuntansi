...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Jurnal Penyesuaian | eAkutansi</title>
                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" id="save_data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 i-kontak">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="nama_kontak" title="* Wajib diisi.<br/>Jika kategori kontak maka isi data <strong>kontak</strong> & jika kategori klien maka isi data <strong>klien</strong>" rel="tooltip" readonly>
                                            ...
                                            <div class="col-md-3 i-klien">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="nama_klien" title="* Wajib diisi.<br/>Jika kategori kontak maka isi data <strong>kontak</strong> & jika kategori klien maka isi data <strong>klien</strong>" rel="tooltip"  readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group input-medium date date-picker" >
                                                    <input type="text" class="form-control" id="tgl" title="* Wajib diisi.<br/>*) Gunakan 2, 4, atau 6 digit angka.<br/> Contoh : <strong>10</strong> maka akan menjadi 10-{month}-{year}.<br/> <strong>1010</strong> maka akan menjadi 10-10-{year}. <br/><strong>101014</strong> maka akan menjadi 10-10-2014." rel="tooltip" onblur="FormatDateField(this)" onfocus="this.select()" required>
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="nama_order" title="* Tidak wajib diisi.<br/>Jika kategori Order maka isi data <strong>order</strong> & jika kategori Konfirmasi Bayar maka isi data Pembayaran ke <strong>eNotaris.com</strong>" rel="tooltip">
                                ...
                                <div class="portlet-footer">
                                    <div class="row">
                                        <div class="col-md-offset-2">
                                            ...
                                            <div class="col-xs-4 col-md-2">
                                                <a class="btn btn-primary" id="simpanplus" onclick="simpanplus();" title="Simpan Data">
                                                    Simpan+
                                                </a> 
                                            </div>
                                        </div>
        ...
        <script>
            ...
            $(".save_data").submit(function(){
                ...
                param = {'jenis'            : "Keuangan",
                  ...
                  $(this).ajaxSubmit({
                    url: '<?php echo base_url('efiling/keuangan2') ?>',
                    type: 'POST',
                    data : {param:param},
                    dataType: 'json',
           ...
           <script>
            ...
            function simpan(nama_file)
            {
                ...
                for(i = 0; i <= a ; i++)
                {
                    ...
                    param[i] = {'isklien'  : isklien,
                             ...
                             'nomor'    : $(".nomor").val(),
                             'urutan'   : i,
                             'file'     : nama_file['nama_acak']
                             }  
                }
                    console.log(param);
                    $.ajax({
                        type:'post',
                        url : "<?php echo base_url('jurnalpenyesuaian/simpan') ?>",
                        data : {param : param},
                        dataType : 'json',
                        success : function (result)
                        {
            ...
            {
                $.ajax({
                    url:"<?php echo base_url('jurnalpenyesuaian/updateNomor') ?>",
                    type:"post",
                    dataType:"json",
                    success:function(resp)
                    {
