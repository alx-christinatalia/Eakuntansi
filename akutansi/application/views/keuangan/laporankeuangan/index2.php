...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Laporan Keuangan | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Tgl Transaksi <font color="red">*</font></label>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>No Transaksi <font color="red">*</font></label>
                                                            <div class="input-group">
                                                   ...
                                                   <div class="form-group">
                                                        ...
                                                        <div class="md-checkbox-inline">
                                                            <div class="md-checkbox">
                                                                <input type="checkbox" id="ttdjurnal" name="ttdjurnal" value="1" class="md-check">
                                                                <label for="ttdjurnal">
                                                                    <span class="inc"></span>
                                    ...
                                    <div class="portlet-body">
                                        <div class="save_data" id="save_data">
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        <label>Bulan/Tahun <font color="red">*</font></label>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                   ...
                                                   <div class="form-group">
                                                        ...
                                                        <div class="md-checkbox-list">
                                                            <div class="md-checkbox">
                                                                <input type="checkbox" id="ttdbuku" name="ttdbuku" value="1" class="md-check">
                                                                <label for="ttdbuku">
                                                                    <span class="inc"></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> Tampilkan Kotak Tanda Tangan </label>
                                                            ...
                                                            <div class="md-checkbox">
                                                                <input type="checkbox" id="kodebuku" name="kodebuku" value="1" class="md-check">
                                                                <label for="kodebuku">
                                                                    <span class="inc"></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> Tampilkan Kode Akun </label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="bulan4">
                                                                        <option value="01">Januari</option>
                                                                        <option value="02">Februari</option>
                                                                        <option value="03">Maret</option>
                                                                        <option value="04">April</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="tahun4">
                                                                    <option value="2027">2027</option>
                                                                    <option value="2025">2026</option>
                                                                    <option value="2024">2024</option>
                                                                    <option value="2023">2023</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="bulan5">
                                                                        <option value="01">Januari</option>
                                                                        <option value="02">Februari</option>
                                                                        <option value="03">Maret</option>
                                                                        <option value="04">April</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="tahun5">
                                                                    <option value="2027">2027</option>
                                                                    <option value="2025">2026</option>
                                                                    <option value="2024">2024</option>
                                                                    <option value="2023">2023</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="bulan6">
                                                                        <option value="01">Januari</option>
                                                                        <option value="02">Februari</option>
                                                                        <option value="03">Maret</option>
                                                                        <option value="04">April</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="tahun6">
                                                                    <option value="2027">2027</option>
                                                                    <option value="2025">2026</option>
                                                                    <option value="2024">2024</option>
                                                                    <option value="2023">2023</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="bulan7">
                                                                        <option value="01">Januari</option>
                                                                        <option value="02">Februari</option>
                                                                        <option value="03">Maret</option>
                                                                        <option value="04">April</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-control" id="tahun7">
                                                                    <option value="2027">2027</option>
                                                                    <option value="2025">2026</option>
                                                                    <option value="2024">2024</option>
                                                                    <option value="2023">2023</option>
        ...
        <!--Form Cetak-->
            <!--Jurnal Transaksi-->
                    <div class="hidden">
                        <form name="form_jurnaltransaksi" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetakjurnaltransaksi" target = '_blank' method="POST">
            ...
            <!--piutang per kontak-->
                    <div class="hidden">
                        <form name="form_piutangperkontak" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetakpiutangperkontak" target = '_blank' method="POST">
            ...
            <!--hutang per kontak-->
                    <div class="hidden">
                        <form name="form_hutangperkontak" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetakhutangperkontak" target = '_blank' method="POST">
                            ...
                            <input type="hidden" name="hutang" id="hutang" value="21" >
                            <input type="hidden" name="hutang1" id="hutang1" value="22" >
            ...
            <!--Buku Besar-->
                    <div class="hidden">
                        <form name="form_bukubesar" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetakbukubesar" target = '_blank' method="POST">
            ...
            <!--Laba / Rugi-->
                    <div class="hidden">
                        <form name="form_labarugi" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetaklabarugi" target = '_blank' method="POST">
            ...
            <!--Perubahan Modal-->
                    <div class="hidden">
                        <form name="form_perubahanmodal" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetakperubahanmodal" target = '_blank' method="POST">
            ...
            <!--Neraca-->
                    <div class="hidden">
                        <form name="form_neraca" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetakneraca" target = '_blank' method="POST">
            ...
            <!--Arus Kas-->
                    <div class="hidden">
                        <form name="form_aruskas" method="POST" action="<?php echo base_url(); ?>/index.php/laporankeuangan/cetakaruskas" target = '_blank' method="POST">
        ...
        <script>
            ...
            function cetakjurnaltransaksi(){
                ...
                $("#jtakuntrans").val( $('#akun option:selected').val());
        ...
        var c_date = "";
            ...
            function tgl_batal(){
             ...
             $( document ).ready(function() {
                 ...
                 $("#kontak2").show();
                 $("#klien2").hide();
                 $("#piutangperkontak").hide();
                 $("#hutangperkontak").hide();
                 $("#bukubesar").hide();
                 $("#labarugi").hide();
                 $("#perubahanmodal").hide();
                 $("#neraca").hide();
