...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Kas Masuk Tambah | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            <?php $this->load->view("template/sidebar", ["active" => "keuangan", "sub" => "kasmasuk"]); ?>
                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" onsubmit="return false;" id="save_data">
                                        ...
                                        <div class="form-group " id="control_0">
                                            <label for="inputnama" class="col-md-2 control-label">Akun Kas/Bank (D)<font color="red"> *</font></label>
                                            <div class="col-md-3">
                                        ...
                                        <div id="f-akun-lawan master">
                                            <div class="form-group controls" id="control_1" style="height:10px">
                                                <label class="col-md-2 control-label">Akun Lawan (K)<font color="red"> *</font></label>
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="col-md-4">
    ...
    <?php $this->load->view('keuangan/kasbankmasuk/modal/tambahkontak') ?>
        ...
        <script>
            ...
            function loadData()
            {
                $.ajax({
                    type:'post',
                    url :"<?php echo base_url('kasmasuk/edit_data/'.$_id) ?>",
                    dataType:'json',
                    success : function(data)
                    {
                        ...
                        for(i=0; i<len; i++)
                        {
                            duit = data['data'].Data[i]['kredit'];
                            (duit == "0" ? duit=data['data'].Data[i]['debit'] : duit=data['data'].Data[i]['kredit']);
            ...
            function TambahForm()
            {
                ...
                c = parseInt(t)+1;
                 ...
                 a +=  '            </div>';
                 a +=  '            <div class="col-md-4">';
                 a +=  '                    <input type="text" class="form-control money " onkeyup="totalD();" onfocus="toN(this);" onblur="toM(this);" value="0">';
                 a +=  '            </div>';
            ...
            function isi_akun_lawan2(c)
            {
                dataAkun = $('#control_1').find(".akun-lawan").html();
                $('#control_'+c).find(".akun-lawan").select2();
                $('#control_'+c).find(".unik").html(dataAkun);
            ...
            function totalD()
            {
                ...
                $(".money").each(function(){
                  ...
                  //  a += returntoN();
                    ...
                    $("#control_0").find(".money").val(returntoM(a));
            ...
            function simpan()
            {
                ...
                for(i = 0; i <= a ; i++)
                {
                    ...
                    if(isklien == "1")
                    {
                     ...
                     jenis = (i != 0 ? "K" : "D" )
                     uang = (i != 0 ? $("#control_"+(parseInt(i))).find('.money').val() : $("#control_"+(parseInt(i))).find('.money').val());
                ...
                console.log(filter)
                    $.ajax({
                        type:'post',
                        url : "<?php echo base_url('kasmasuk/update') ?>",
