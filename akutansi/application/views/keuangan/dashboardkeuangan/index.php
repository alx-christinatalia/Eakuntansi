                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="page-title">
                                    <h1>Keuangan <a data-date="" id="m_bulan"></a></h1>
                                </div>
                            </div>  
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        <div class=" bg-default bg-font-default " style="height: 75px; text-align: center;">
                                            <a id="link_open" href="" class="col-md-6" style="padding-top: 10px">
                                            ...
                                            <a id="link_close" href="" class="col-md-6" style="padding-top: 10px">
