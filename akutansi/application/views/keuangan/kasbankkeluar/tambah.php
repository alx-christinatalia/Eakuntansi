...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>KasKeluar Tambah | eAkutansi</title>
                            ...
                            <div class="col-md-2 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center form-action">                                               
                                        <a class="btn btn-primary" id="_simpan" onclick="_simpan();" title="Simpan Data">
                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" id="save_data">
                                        ...
                                        <div class="form-group" id="control_0">
                                            <label for="inputnama" class="col-md-2 control-label">Akun Kas/Bank (K)</label>
                                            <div class="col-md-3">
                                        ...
                                        <div id="f-akun-lawan master">
                                            <div class="form-group controls" id="control_1" style="height:10px">
                                                <label class="col-md-2 control-label">Akun Lawan (D)</label>
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="col-md-4">
    ...
    <?php $this->load->view('keuangan/kasbankmasuk/modal/tambahkontak') ?>
        ...
        <script>
           ...
           <script>
            ...
            {
                $.ajax({
                    url:"<?php echo base_url('kaskeluar/updateNomor') ?>",
                    type:"post",
                    dataType:"json",
                    success:function(resp)
                    {
