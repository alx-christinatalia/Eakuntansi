...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Jurnal Umum | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            <?php $this->load->view("template/sidebar", ["active" => "keuangan", "sub" => "jurnalumum"]); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group input-medium date date-picker" >
                                                    <input type="text" class="form-control" id="tgl" title="* Wajib diisi.<br/>*) Gunakan 2, 4, atau 6 digit angka.<br/> Contoh : <strong>10</strong> maka akan menjadi 10-{month}-{year}.<br/> <strong>1010</strong> maka akan menjadi 10-10-{year}. <br/><strong>101014</strong> maka akan menjadi 10-10-2014." onblur="FormatDateField(this)" onfocus="this.select()" rel="tooltip" required>
                                                    <span class="input-group-btn">
        ...
        <script>
           ...
           <script>
            ...
            function simpan(nama_file)
            {
              ...
              $.ajax({
                  type:'post',
                  url : "<?php echo base_url('jurnalumum/simpan') ?>",
                  data : {param : param},
                  dataType : 'json',
                  success : function (result)
                  {
            ...
            {
                    $.ajax({
                        url:"<?php echo base_url('jurnalumum/updateNomor') ?>",
                        type:"post",
                        dataType:"json",
                        success:function(resp)
                        {
