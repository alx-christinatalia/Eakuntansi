...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Saldo Awal Edit | eNotaris.com</title>
                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal save_data" onsubmit="return false;" id="save_data">
                                        ...
                                        <div id="f-akun-lawan master">
                                            <div class="form-group controls" id="control_0" style="height:10px">
                                                <label class="col-md-2 control-label">Akun <font color="red"> *</font></label>
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="col-md-4">
    ...
    <?php $this->load->view('keuangan/kasbankmasuk/modal/tambahkontak') ?>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                refSelect2();
                $.when(isi_akun_lawan(),defaultVal(),isi_akun_kas()).done(function(){
                    loadData();
                })
            })
            ...
            function defaultVal()
            {
                 return $.ajax({
                    type:'post',
                    url:'<?php echo base_url('saldoawal/isi_akun_lawan') ?>',
                    dataType:'json',
                    success : function (result){
                        $('#control_0').find(".unik").html(result);
                    }
                 })
            }
            ...
            function loadData()
            {
                $.ajax({
                    type:'post',
                    url :"<?php echo base_url('saldoawal/edit_data/'.$_id) ?>",
                    dataType:'json',
            ...
            {
                t = parseInt($(".controls").length)-1;
                dataAkun = $('#control_0').find(".unik").html();
                $('#control_'+t).find(".unik").select2();
                $('#control_'+t).find(".unik").html(dataAkun);
            ...
            function isi_akun_lawan(c)
            {
                ...
                return $.ajax({
                    ...
                    dataType:'json',
                    success : function (result){
                        $('#control_0').find(".akun-lawan").select2();
            ...
            function isi_akun_kas()
            {
                return $.ajax({
                    type:'post',
                    url:'<?php echo base_url('saldoawal/isi_akun_kas') ?>',
                    dataType:'json',
                    success : function (result){
           ...
           <script>
            ...
            function simpan()
            {
                ...
                tleght = parseInt($(".controls").length);
