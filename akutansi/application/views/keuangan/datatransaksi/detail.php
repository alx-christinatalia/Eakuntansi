...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Detail Transaksi || eNotaris.com</title>
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center form-action">     
                                        <a class="btn btn-primary" href="<?php echo base_url('/'.$jenis.'/edit/'.$data->nomor) ?>" title="Edit Data">
                                            <i class="fa fa-pencil-square-o"></i>
                                        </a>                                     
                                        <a class="btn btn-primary" href="<?php echo base_url('/'.$jenis.'/tambah'); ?>" title="Refresh Data (Reload Halaman)">
