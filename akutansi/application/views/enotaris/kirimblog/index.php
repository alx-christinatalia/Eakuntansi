...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Data Blog | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    ...
                                    <div class="form-group text-center form-action">
                                        <a href="<?php echo base_url("kirimblog/tambah"); ?>" class="btn btn-primary" title="Upload Dokumen">
        ...
        <script type="text/javascript">
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "/index.php/kirimblog";
