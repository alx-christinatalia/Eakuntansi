...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Panduan | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            <?php $this->load->view("template/sidebar", ["active" => "enotaris", "sub" => "panduan"]); ?>
        ...
        <script type="text/javascript">
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "/index.php/panduan";
