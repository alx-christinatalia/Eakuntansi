...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    <div class="form-group text-center">
                                        <form id="frmSearch" action="">     
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari Data User..." value="<?php echo $this->input->post("kywd"); ?>" name="kywd" id="kywd" class="form-control" autofocus> 
                                    ...
                                    <div class="form-group text-center form-action">
                                        <a href="<?php echo base_url("notarisuser/tambah"); ?>" class="btn btn-primary" title="Upload Dokumen">
        ...
        <script type="text/javascript">
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "/index.php/notarisuser";
            ...
            function hapusData(selector) {
                ...
                $("#btnDelete").attr("href", base_url + "/index.php/notarisuser/delete/" + id);
