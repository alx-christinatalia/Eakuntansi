...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Monitoring BPN | eNotaris.com</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 text-right">
                                <div class="title-action form-inline">
                                    ...
                                    <div class="form-group text-center form-action">
                                        ...
                                        <a role="button" class="btn btn-primary " href="<?php echo base_url(); ?>monitoringBPN/cetak" title="Print data Monitoring BPN" target="_blank">
        ...
        <script type="text/javascript">
            ...
            var page = 1, kywd = "", limit = 10, filter = {"sort" : "_id desc"}, utama = "monitoringBPN";
            var m_kywd="" , m_utama ="", m_table="";
            var data;

            $(document).ready(function() {
                loadTable( "#list-data" ,kywd, page, limit, filter, utama, 6).done(function(){
                    refid()
                });
