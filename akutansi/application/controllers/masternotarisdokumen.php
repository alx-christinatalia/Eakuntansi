...
class masternotarisdokumen extends CI_Controller {
    ...
    public function index()
    {
        if($this->input->is_ajax_request() and $this->input->post("action") and $this->input->post("param")) {
            ...
            $this->load->view('administrator/masternotarisdokumen/index');   
        }
    ...
    //view
        ...
        {
            $this->load->view('administrator/masternotarisdokumen/tambah');
        }

        public function edit($id)
        {
            $data = $this->sWhere('notarisdokumen','_id',$id);
            $this->load->view('administrator/masternotarisdokumen/edit',array('data' => $data));
        }
    //
    ...
    //simpan
        public function simpan()
        {
            ...
            $output = $this->insert('notarisdokumen',$data);
    ...
    //Update
        ...
        {
            $data = $this->input->post('param');
            $output =$this->update('notarisdokumen','_id',$id,$data);
            echo json_encode($output);
        }
    ...
    //Get Data
        ...
        {
            $output = $this->sWhere('notarislayanan','id_layanan',$id_layanan);
    ...
    //Delete Data
        ...
        {
            $output = $this->delete('notarisdokumen','_id',$id);
            echo json_encode($output);
        }
