   ...
   public function edit_data($_id)
   {
    ...
    public function simpan()
    {
        ...
        foreach ($a as $key => $value) {
            ...
            $value['akun_k'] = $c[0];
            $out[$key] =  $this->m_insert_o('fintransaksi',$value);
        }

        $log = $this->DoList->user_log("fintransaksi","Tambah Kas/Bank Keluar",$a[0]['nomor'],"Nomor Transaksi ".$a[0]['nomor']);
    ...
    public function update()
    {
        ...
        echo json_encode("Ins ".$Ins." Up ".$Up." Del ".$Del." DB ".$defbaris." Now ".$totalbaris);
    }
