...
class wasiat extends CI_Controller {
    ...
    public function index($_id)
    {
        ...
        $this->load->view("order/berkasorder/wasiat",array("MASTER_ID_ORDER" => $_id, 'no_akta' => $data)); 
    }
        ...
        foreach($data->Data as $result)
        {
            $pilih = $result->dipilih;
                $return .= "<tr>";
                        ...
                        $return .= "<td>{$result->pihak_sbg}</td>";
                        $return .= "<td>{$result->identitas_pihak}</td>";
                        $return .= "<td>{$result->hubungan_pihak}</td>";
                        $return .= "<td>{$result->pekerjaan}</td>";
                    $return .= "</tr>";
        }
