...
class skmht extends CI_Controller {
    ...
    {
        $this->load->view("order/berkasorder/skmht",array("MASTER_ID_ORDER" => $_id)); 
    }
        ...
        foreach($data->Data as $result)
        {
            $pilih = $result->dipilih;
                $return .= "<tr>";
                        ...
                        $return .= "<td class='tp-pihak'>{$result->pihak}</td>";
                        $return .= "<td>{$result->identitas}</td>";
                        $return .= "<td class='tp-jenis_pihak'>{$result->jenis_pihak}</td>";
                    $return .= "</tr>";
        }
