...
class fidusia_perorangan extends CI_Controller {
    ...
    public function index($_id)
    {
        ...
        $this->load->view("order/berkasorder/fidusia_perorangan",array("MASTER_ID_ORDER" => $_id,
                                                                       "akta_order" => $pelanggan , "akta_progres" => $progres , "pf" => $pekerjaan ,"tow" => $tobyekwarna ,"tom" => $tobyekmerk ,"tojb" => $tobyekjenisb ,"tojtb" => $tobyekjenistb ,"tobd" => $tobdikeluarkan ,"tob" => $tobukti ,"tmu" => $tmatauang ,"kt" => $kategori)); 
    }
    ...
    public function simpan(){
            ...
            $value["obyek_bukti_tgl"] = date("Y-m-d H:i:s", strtotime($value["obyek_bukti_tgl"]));
            $value["penerima_tgl_lahir"] = date("Y-m-d H:i:s", strtotime($value["penerima_tgl_lahir"]));
            $value["setuju_tgl_lahir"] = date("Y-m-d H:i:s", strtotime($value["setuju_tgl_lahir"]));
            $value["setuju_dudajanda_tgl"] = date("Y-m-d H:i:s", strtotime($value["setuju_dudajanda_tgl"]));
            ...
            $value["janji_tgl_jangka_waktu"] = date("Y-m-d H:i:s", strtotime($value["janji_tgl_jangka_waktu"]));
            $value["janji_tgl_jangka_waktu_akhir"] = date("Y-m-d H:i:s", strtotime($value["janji_tgl_jangka_waktu_akhir"]));
