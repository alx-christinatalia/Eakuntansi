...
class penutupan_PT extends CI_Controller {
    ...
    {
        $this->load->view("order/berkasorder/penutupan_pt",array("MASTER_ID_ORDER" => $_id)); 
    }
    ...
    public function DUinsup($tbl,$data,$sort,$limit,$filter,$id,$where)
    {
        $check = $this->getData($tbl,
                            ...
                            "",
                            "");
        $data['tgl_berdiri'] = date("Y-m-d", strtotime($data['tgl_berdiri']));
