...
class jual_beli_tidak_lunas extends CI_Controller {
    ...
    {
        $this->load->view("order/berkasorder/jual_beli_tidak_lunas",array("MASTER_ID_ORDER" => $_id)); 
    }
        ...
        foreach($data->Data as $result)
        {
            $pilih = $result->dipilih;
                $return .= "<tr>";
                        ...
                        $return .= "<td>{$result->pihak_ke}</td>";
                        $return .= "<td>{$result->pihak_alias}</td>";
                        $return .= "<td>{$result->nama}</td>";
                        $return .= "<td>{$result->ket}</td>";
                        $return .= "<td>{$result->file}</td>";
                    $return .= "</tr>";
        }
