...
class jurnalumum extends CI_Controller {
   ...
   {
    $this->load->view('keuangan/jurnalumum/tambah', array("ssb" => $this->get_ssb()));
   }
   ...
   public function edit_data($_id)
   {
    ...
    public function simpan()
    {
        ...
        $log = $this->DoList->user_log("fintransaksi","Tambah Data Jurnal Umum ",$g[0]["nomor"],$g[0]["uraian"]);
    ...
    {
        $this->load->view('keuangan/jurnalumum/edit', array( "_id" => $_id));
    }
    ...
    public function update()
    {
        ...
        $log = $this->DoList->user_log("fintransaksi","Edit Data Jurnal Umum",$nomorTrans,$getFilter["uraian"]);
